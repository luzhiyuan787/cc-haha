export const en = {
  ...
  "chat.collaborationBlocked": "Needs attention",
  "chat.collaborationCompleted": "Completed",
  "chat.collaborationFailed": "Failed",
  "chat.collaborationStopped": "Stopped",
  ...
  "extensions.managedSkillHint": "Companion skills are managed with their plugin. Manage local and project skills in their source directories.",
  "extensions.searchPlugins": "Search plugins",
  "extensions.searchSkills": "Search featured skills",
  "extensions.pluginsSubtitle": "Connect everyday services or add creative and development tools to your assistant.",
  "extensions.filter": "Filter extensions",
  "extensions.categories": "Extension categories",
  "extensions.empty": "No matching extensions",
  "chat.references": "References",
  "chat.referencePlugins": "Plugins",
  "chat.referenceSkills": "Skills",
  "chat.referenceFiles": "Files",
  "chat.referencesLoadFailed": "Could not load skills and plugins",
  "chat.referencesEmpty": "No matching references",
  "chat.referenceDescription": "Description",
  "chat.referenceSource": "Source",
  "chat.referenceDetails": "Reference details",
  "sidebar.extensions": "Skills · Connectors",
  "extensions.sections": "Market sections",
  "extensions.plugins": "Plugins",
  "extensions.skills": "Skills",
  "extensions.featuredSkills": "Featured skills",
  "connectors.airtable.description": "Query tables, records and team information.",
  "connectors.airtable.example": "Review recently updated project records in Airtable.",
  "connectors.airtable.name": "Airtable",
  "connectors.airtable.requirements": "Authorize workspaces or bases in the browser. Enterprise administrators may restrict client access.",
  "connectors.algorithmic-art.name": "Algorithmic art",
  "connectors.algorithmic-art.description": "Create adjustable algorithmic art and interactive visuals with p5.js.",
  "connectors.algorithmic-art.example": "Build a flow-field artwork page with adjustable colors and density.",
  "connectors.algorithmic-art.requirements": "Includes templates and reference code. Previewing needs a browser and p5.js resources. Installation does not execute scripts or call generation models.",
  "connectors.atlassian.description": "Search Jira, Confluence and project collaboration content.",
  "connectors.atlassian.example": "Summarize my Jira issues and link relevant Confluence pages.",
  "connectors.atlassian.name": "Atlassian",
  "connectors.atlassian.requirements": "Requires an Atlassian Cloud account and product access through browser authorization. Some products and operations need administrator enablement.",
  "connectors.bazhuayu.description": "Find collection templates, cloud tasks and collected data.",
  "connectors.bazhuayu.example": "List supported platforms without creating or starting collection tasks.",
  "connectors.bazhuayu.name": "Octoparse China",
  "connectors.bazhuayu.requirements": "Requires an Octoparse China account API Key. Cloud collection only; running tasks may consume balance and some templates require specific plans.",
  "connectors.canvas-design.name": "Canvas design",
  "connectors.canvas-design.description": "Create posters, static artwork and PDF canvases, with bundled fonts.",
  "connectors.canvas-design.example": "Design a technology event poster and export it as PDF.",
  "connectors.canvas-design.requirements": "Includes the complete design skill, fonts and their licenses. Image or PDF generation needs Python and suitable drawing libraries, which are not installed automatically.",
  "connectors.clickup.description": "Find projects, tasks and team work materials.",
  "connectors.clickup.example": "List unfinished ClickUp tasks assigned to me.",
  "connectors.clickup.name": "ClickUp",
  "connectors.clickup.requirements": "Requires a ClickUp account and workspace access, authorized in the browser. The service is in public beta.",
  "connectors.cloudflare.description": "Inspect and manage websites, networking and cloud resources.",
  "connectors.cloudflare.example": "Review my Cloudflare resources and summarize their configuration.",
  "connectors.cloudflare.name": "Cloudflare",
  "connectors.cloudflare.requirements": "Requires a user or account API Token with the necessary resource permissions. Deployments and configuration changes require an explicit task.",
  "connectors.drawio.name": "draw.io diagrams",
  "connectors.drawio.description": "Create editable architecture, flow and relationship diagrams.",
  "connectors.drawio.example": "Turn this system description into an editable draw.io architecture diagram.",
  "connectors.drawio.requirements": "Write .drawio XML directly. Mermaid conversion, automatic layout and image export require the draw.io desktop CLI. Installing this skill does not install the desktop app.",
  "connectors.firecrawl.description": "Search the web and extract pages for research.",
  "connectors.firecrawl.example": "Find technical resources on browser automation and keep source links.",
  "connectors.firecrawl.name": "Firecrawl",
  "connectors.firecrawl.requirements": "Requires a Firecrawl API Key. Usage is billed against the account quota; the key is sent in a secure request header.",
  "connectors.frontend-design.name": "Frontend design",
  "connectors.frontend-design.description": "Build frontend interfaces with clear visual hierarchy.",
  "connectors.frontend-design.example": "Design and implement a home page for my knowledge management app.",
  "connectors.frontend-design.requirements": "Installs the Anthropic frontend design skill. Previewing and building require the target project dependencies and runtime. Hosting and image generation services are not included.",
  "connectors.hyperframes.name": "HyperFrames",
  "connectors.hyperframes.description": "Create HTML videos, captions and product demos.",
  "connectors.hyperframes.example": "Create a 20-second product introduction with HyperFrames.",
  "connectors.hyperframes.requirements": "Installs five complete skills and references, not a renderer. Rendering needs Node.js 22+, HyperFrames CLI and FFmpeg. Local speech may need Python 3.10+; online media services need separate setup and may charge fees.",
  "connectors.intercom.description": "Search customer conversations, contacts and help content.",
  "connectors.intercom.example": "Summarize common questions in recent customer feedback.",
  "connectors.intercom.name": "Intercom",
  "connectors.intercom.requirements": "US-hosted workspaces only. Requires an access token with contact, conversation and article permissions.",
  "connectors.jufa.description": "Find court cases and summarize judicial reasoning.",
  "connectors.jufa.example": "Find construction contract cases and cite case numbers, courts and reasoning.",
  "connectors.jufa.name": "Jufa Cases",
  "connectors.jufa.requirements": "Requires a Jufa Agent API Key. This connector covers case research; other topics need separate integration. Plan and call quotas apply.",
  "connectors.kuaicha.description": "Research company registrations, operations and risks.",
  "connectors.kuaicha.example": "Check a company’s registration and business exceptions, identifying missing data.",
  "connectors.kuaicha.name": "THS Kuaicha",
  "connectors.kuaicha.requirements": "Requires a Kuaicha API Key. Only mainland China IP addresses are supported. Account permissions and quotas apply.",
  "connectors.listinggood.description": "Review Amazon listings for compliance and readability.",
  "connectors.listinggood.example": "Review the Amazon listing text I provide and suggest improvements.",
  "connectors.listinggood.name": "ListingGood",
  "connectors.listinggood.requirements": "Requires a ListingGood China API Key. China and global keys are not interchangeable. Paid tools consume account quota.",
  "connectors.mcp-builder.name": "MCP builder",
  "connectors.mcp-builder.description": "Build and evaluate MCP servers with TypeScript and Python references.",
  "connectors.mcp-builder.example": "Design an MCP server for our internal knowledge base.",
  "connectors.mcp-builder.requirements": "Includes design references and evaluation scripts. Development needs Node.js or Python and an MCP SDK. Model evaluations and third-party APIs require user-provided credentials and may incur charges.",
  "connectors.miro.description": "Review collaborative boards and organize design discussions.",
  "connectors.miro.example": "Summarize the ideas and action items on a Miro board I choose.",
  "connectors.miro.name": "Miro",
  "connectors.miro.requirements": "Requires a Miro account and board access. Organization administrators may need to enable MCP.",
  "connectors.neon.description": "Inspect database projects, branches and development schemas.",
  "connectors.neon.example": "Inspect my Neon development database schema without changing data.",
  "connectors.neon.name": "Neon",
  "connectors.neon.requirements": "Requires a Neon API Key and project access. The provider recommends development and test databases.",
  "connectors.obsidian.name": "Obsidian toolkit",
  "connectors.obsidian.description": "Edit Markdown notes, Canvas boards and Bases views.",
  "connectors.obsidian.example": "Turn these project notes into an Obsidian Canvas relationship map.",
  "connectors.obsidian.requirements": "Local file editing needs no cloud account. CLI operations require Obsidian to be installed and running. Optional extraction and templating features need their own CLIs. Only skill files are installed.",
  "connectors.postman.description": "Find API workspaces, collections and development resources.",
  "connectors.postman.example": "Find login-related APIs in my Postman workspace.",
  "connectors.postman.name": "Postman",
  "connectors.postman.requirements": "Authorize a US-region Postman account in the browser. This connector uses the minimal tool set; EU accounts need a separate API-key configuration.",
  "connectors.qcc.description": "Look up companies and verify registration information.",
  "connectors.qcc.example": "Find registration information for a company I specify and cite sources.",
  "connectors.qcc.name": "Qichacha",
  "connectors.qcc.requirements": "Requires a Qichacha Agent API Key. This connector covers basic company information only; other topics require separate integration. Account permissions and credits apply.",
  "connectors.qingflow.description": "Query workspace apps and business data for workflow collaboration.",
  "connectors.qingflow.example": "Review accessible Qingflow apps and summarize pending work.",
  "connectors.qingflow.name": "Qingflow",
  "connectors.qingflow.requirements": "Requires a Qingflow account with browser authorization. Workspace and app permissions apply; capabilities depend on the plan.",
  "connectors.qveris.description": "Discover data tools for information research.",
  ...
  "connectors.render.requirements": "Requires a Render API Key. Select a workspace first. The key accesses workspaces you belong to; deployments require an explicit task.",
  "connectors.sorftime.description": "Research cross-border commerce, products and keywords.",
  "connectors.sorftime.example": "Research a product’s market trends with marketplace, dates and data sources.",
  "connectors.sorftime.name": "Sorftime",
  "connectors.sorftime.requirements": "Requires Sorftime MCP activation and an Account-SK. Purchased services determine platforms, marketplaces and query limits.",
  "connectors.todoist.description": "Review tasks, projects and personal schedules.",
  "connectors.todoist.example": "List my overdue Todoist tasks and tasks due today.",
  "connectors.todoist.name": "Todoist",
  "connectors.todoist.requirements": "Requires a Todoist account with browser authorization for tasks and projects.",
  "connectors.variflight.description": "Look up flight status, airports and travel information.",
  "connectors.variflight.example": "Check a flight’s scheduled time and current status with a query timestamp.",
  "connectors.variflight.name": "VariFlight",
  "connectors.variflight.requirements": "Sign in to the VariFlight MCP platform to generate an MCP Key. Personal itineraries need account access; provider quotas and data limits apply.",
  "connectors.webapp-testing.name": "Web app testing",
  "connectors.webapp-testing.description": "Inspect local web pages, interactions and screenshots with Playwright.",
  "connectors.webapp-testing.example": "Check form validation and layout in my local app.",
  "connectors.webapp-testing.requirements": "Includes the testing skill, Python helpers and examples. Running tests needs Python, Playwright, a browser and the target app. Installation does not download browsers.",
  "connectors.webflow.description": "Read website structure, CMS content and design context.",
  "connectors.webflow.example": "Inspect CMS collections and fields on my Webflow site.",
  "connectors.webflow.name": "Webflow",
  "connectors.webflow.requirements": "Requires a Webflow account with site access. OAuth installs the MCP Bridge App; Designer operations require the bridge connection.",
  "connectors.xmind.description": "Read and organize online mind maps for planning.",
  "connectors.xmind.example": "List recent online Xmind maps and summarize the one I select.",
  "connectors.xmind.name": "Xmind",
  "connectors.xmind.requirements": "Requires a mainland China Xmind account with browser authorization. Only authorized team maps are accessible; editing depends on the plan.",
  "connectors.toolsRemoveInfo": "Remove this tool plugin and its skill files. Existing tasks and output files are kept.",
  "connectors.collection": "Catalog type",
  "connectors.services": "Service connectors",
  "connectors.tools": "Tool plugins",
  "connectors.region": "Service region",
  "connectors.region.all": "All regions",
  "connectors.region.china": "China services",
  "connectors.region.global": "Global services",
  "connectors.toolKind": "Tool plugin",
  "connectors.toolsSubtitle": "Add focused skills and working methods to your tasks.",
  "connectors.skillsLoaded": "Skills loaded",
  "connectors.skillsPending": "Skills not loaded",
  "connectors.verifySkills": "Verify skills",
  "connectors.skillsRuntimeInfo": "This installs a skill package. Node.js, command-line tools, or other runtimes required by a task must be available separately. Loaded skills do not mean those dependencies are installed.",
  "connectors.saveAndVerify": "Save and verify",
  "connectors.needsService": "Needs service connection",

  "connectors.jinshuju.name": "Jinshuju",
  "connectors.jinshuju.description": "Review forms and collected responses for analysis.",
  "connectors.jinshuju.example": "Summarize recently collected questionnaire responses in Jinshuju.",
  "connectors.jinshuju.requirements": "Requires a Jinshuju account. Authorize form and data access in the browser.",
  "connectors.tencent-docs.name": "Tencent Docs",
  "connectors.tencent-docs.description": "Read and organize online documents and spreadsheets.",
  "connectors.tencent-docs.example": "Find project planning materials in Tencent Docs.",
  "connectors.tencent-docs.requirements": "Requires a Tencent Docs MCP access token. Only documents already accessible to the account can be used.",
  "connectors.pkulaw.name": "PKULaw",
  "connectors.pkulaw.description": "Search laws and regulations with original sources.",
  "connectors.pkulaw.example": "Find legal provisions on employment probation periods and cite the sources.",
  "connectors.pkulaw.requirements": "Requires a PKULaw MCP access token and access to the relevant materials. Check whether retrieved provisions are currently effective.",
  "connectors.datayes.name": "Datayes",
  "connectors.datayes.description": "Retrieve stock prices and financial market data for research.",
  "connectors.datayes.example": "Find historical prices for a stock I specify and record the data sources.",
  "connectors.datayes.requirements": "Requires a Datayes MCP Token. Data access depends on account permissions and quota. Enterprise accounts must meet the provider’s verification requirements.",
  "connectors.tencent-search.name": "Tencent Cloud Search",
  "connectors.tencent-search.description": "Search web resources with traceable sources.",
  "connectors.tencent-search.example": "Research the development of China’s low-altitude economy and collect official sources.",
  "connectors.tencent-search.requirements": "Requires Tencent Cloud WSA service activation and an API Key. Account quotas and billing rules apply.",
  "connectors.connectService": "Connect service",
  "connectors.officialMcp": "Official MCP service",

  "connectors.amap.name": "Amap",
  "connectors.amap.description": "Search places, plan routes and check travel information.",
  "connectors.amap.example": "Plan a public transit route from Hangzhou East Station to West Lake.",
  "connectors.amap.requirements": "Requires an Amap Web Service API Key. Services depend on the account permissions and quota.",
  "connectors.baidu-maps.name": "Baidu Maps",
  "connectors.baidu-maps.description": "Geocode addresses, search nearby places and plan routes.",
  "connectors.baidu-maps.example": "Find hotels and transport near Shanghai Hongqiao Station.",
  "connectors.baidu-maps.requirements": "Requires a Baidu Maps server-side AK and access to the relevant services.",
  "connectors.tencent-maps.name": "Tencent Maps",
  "connectors.tencent-maps.description": "Look up locations, distances and travel routes.",
  "connectors.tencent-maps.example": "Compare transit and driving routes from Guangzhou South Station to Canton Tower.",
  "connectors.tencent-maps.requirements": "Requires a Tencent Location Service Key with WebServiceAPI permissions and quota.",
  "connectors.zhipu-search.name": "Zhipu Web Search",
  "connectors.zhipu-search.description": "Search Chinese webpages, news and current information with sources.",
  "connectors.zhipu-search.example": "Find recent Chinese electric vehicle policies and link the original sources.",
  "connectors.zhipu-search.requirements": "Requires a GLM Coding Plan API Key. Team plan keys and general platform keys are not interchangeable.",
  "connectors.notion.name": "Notion",
  "connectors.notion.description": "Search workspace content and organize pages and project knowledge.",
  "connectors.notion.example": "Find recent project reports in Notion and summarize progress.",
  "connectors.notion.requirements": "Requires a Notion account. Browser authorization only grants access to workspace content available to that account.",
  "connectors.linear.name": "Linear",
  "connectors.linear.description": "Find issues, projects and cycles to follow team work.",
  "connectors.linear.example": "List unfinished Linear issues assigned to me.",
  "connectors.linear.requirements": "Requires a Linear workspace account and project permissions. Connect through browser authorization.",
  "connectors.github.name": "GitHub",
  "connectors.github.description": "Search repository code, issues and pull requests.",
  "connectors.github.example": "Find pull requests awaiting review in my GitHub repositories.",
  "connectors.github.requirements": "Requires a GitHub Personal Access Token with permissions for the needed repositories and operations. Organization policies still apply.",
  "connectors.context7.name": "Context7",
  "connectors.context7.description": "Find current library documentation and usage examples.",
  "connectors.context7.example": "Find React useEffect documentation and cleanup function examples.",
  "connectors.context7.requirements": "Uses the official anonymous access allowance. Access is limited and the service may return quota errors.",
  "connectors.sentry.name": "Sentry",
  "connectors.sentry.description": "Inspect errors, issues and application runtime information.",
  "connectors.sentry.example": "Summarize errors first seen in Sentry during the last day.",
  "connectors.sentry.requirements": "Requires a Sentry account with organization and project permissions. Connect through browser authorization.",
  "connectors.tavily.name": "Tavily",
  "connectors.tavily.description": "Search webpages and extract content for research.",
  "connectors.tavily.example": "Compare open-source vector databases and cite sources.",
  "connectors.tavily.requirements": "Requires a Tavily API Key. Calls use the account subscription and quota.",
  "connectors.exa.name": "Exa",
  "connectors.exa.description": "Discover related webpages, code and technical resources.",
  "connectors.exa.example": "Find technical articles about observability in distributed systems.",
  "connectors.exa.requirements": "Uses the official basic anonymous allowance. Available tools and usage limits are set by the provider.",
  "connectors.supabase.name": "Supabase",
  "connectors.supabase.description": "Inspect projects, database schemas and development resources.",
  "connectors.supabase.example": "Inspect the tables in my Supabase project without changing data.",
  "connectors.supabase.requirements": "Requires a Supabase account with organization and project access. Database writes still require an explicit task instruction.",
  "connectors.huggingface.name": "Hugging Face",
  "connectors.huggingface.description": "Discover models, datasets and machine learning research.",
  "connectors.huggingface.example": "Find public models and datasets for Chinese text classification.",
  "connectors.huggingface.requirements": "Requires a Hugging Face token. Read permissions are recommended for search; compute tasks may incur separate charges.",
  "connectors.canva.name": "Canva",
  "connectors.canva.description": "Find design assets and collaborate on design content.",
  "connectors.canva.example": "Find recent brand design assets in Canva.",
  "connectors.canva.requirements": "Each user authorizes their own Canva account. Some capabilities depend on subscription and team permissions.",
  "connectors.figma.name": "Figma",
  "connectors.figma.description": "Read design context, components and interface structure.",
  "connectors.figma.example": "Analyze the components in a Figma design link I provide.",
  "connectors.figma.requirements": "Requires Figma account authorization. Design access, seats and plan determine available tools and usage.",
  "connectors.stripe.name": "Stripe",
  "connectors.stripe.description": "Find customer, billing and payment business information.",
  "connectors.stripe.example": "Review recent Stripe invoices without creating payments or refunds.",
  "connectors.stripe.requirements": "Requires Stripe account authorization. The official service is in preview; payments, refunds and other writes need explicit task instructions.",
  "connectors.category.legal": "Legal",

  "connectors.categories": "Service categories",
  "connectors.allCategories": "Featured",
  "connectors.category.office": "Office",
  "connectors.category.development": "Development",
  "connectors.category.search": "Search",
  "connectors.category.maps": "Maps",
  "connectors.category.data": "Data",
  ...
  "connectors.loadFailed": "Could not complete the action",
  "connectors.emptyAdded": "Add your workplace services to manage accounts and connections here.",
  "connectors.emptySearch": "Try another keyword or category.",
  "connectors.resetFilters": "View all",
  "connectors.configuration": "Connection settings",
  "connectors.configurationHint": "Leave blank to keep saved settings. Enter new settings, then choose Save and verify to validate the connection.",
  "connectors.fieldRequired": "This field is required",
  "connectors.capabilities": "Capabilities",
  "connectors.remoteExample": "Use {name} to find information I can access.",
  "connectors.remoteRequirements": "A service account and the required access permissions may be needed. Available operations depend on the provider’s granted permissions.",

  "connectors.phase.installing-plugin": "Installing companion skills",
  "connectors.phase.checking": "Checking account connection",
  "connectors.phase.enabling-plugin": "Enabling companion skills",
  "connectors.phase.refreshing-sessions": "Refreshing task capabilities",
  "connectors.phase.verifying-runtime": "Checking local runtime",
  "connectors.phase.persistence": "Saving connection state",
  "connectors.phase.cancelling": "Cancelling operation",
  "connectors.feishu.requirements": "Requires a Feishu user account and calendar access. Available capabilities depend on permissions granted to the account and app.",
  "connectors.dingtalk.requirements": "Requires DingTalk OAuth login and calendar permissions granted by an enterprise administrator. Login alone does not grant all service permissions.",
  "connectors.wecom.requirements": "Requires a configured WeCom bot or user identity and calendar permissions. Available operations depend on permissions granted to that identity.",

  "connectors.update": "Update",
  "connectors.updateAvailable": "Update available",
  "connectors.currentAccount": "Current service account",

  "connectors.phase.downloading": "Downloading runtime",
  "connectors.phase.extracting": "Extracting runtime",
  "connectors.phase.verifying": "Verifying runtime",
  "connectors.phase.awaiting-authorization": "Waiting for account authorization",
  "connectors.phase.configuring-account": "Configuring account",
  "connectors.phase.authorizing": "Authorizing",
  "connectors.phase.failed": "Failed stage",
  "connectors.phase.skillsInfo": "Includes skills for operating this service after installation.",

  'connectors.status.configured': 'Configured locally',
  'connectors.localVerification': 'Service permissions will be verified on the first task invocation.',
  "sidebar.connectors": "Connectors",
  "connectors.subtitle": "Connect workplace services to give skills access to real capabilities.",
  "connectors.filter": "Filter connectors",
  "connectors.all": "All",
  "connectors.added": "Added",
  "connectors.search": "Search connectors",
  "connectors.clear": "Clear search",
  "connectors.retry": "Retry",
  "connectors.loading": "Loading…",
  "connectors.empty": "No matching connectors",
  "connectors.details": "Details",
  "connectors.start": "Start using",
  "connectors.account": "Account",
  "connectors.noAccount": "Account not verified",
  "connectors.platforms": "Platforms",
  "connectors.source": "Source",
  "connectors.version": "Version",
  "connectors.skills": "Companion skill plugin",
  "connectors.homepage": "Project homepage",
  "connectors.example": "Example",
  "connectors.waiting": "Working. Complete authorization and wait for the status to update.",
  "connectors.authorize": "Open authorization page",
  "connectors.confirm": "Confirm action",
  "connectors.continue": "Continue",
  "connectors.shared": "This connector shares the local CLI account credentials. Connecting or switching accounts affects other apps using the same CLI. Confirm before continuing.",
  "connectors.isolated": "Credentials are isolated within this app.",
  "connectors.removeInfo": "Remove the app-managed connector while preserving shared account credentials.",
  "connectors.invalidUrl": "Invalid authorization URL",
  "connectors.openFailed": "Could not open the link. Try again.",
  "connectors.startFailed": "Could not create a task. Try again.",
  "connectors.unsupported": "Platform unsupported",
  "connectors.action.prepare": "Add",
  "connectors.action.authenticate": "Connect account",
  "connectors.action.check": "Check connection",
  "connectors.action.deactivate": "Deactivate",
  "connectors.action.remove": "Remove",
  "connectors.status.not-installed": "Not added",
  "connectors.status.preparing": "Preparing",
  "connectors.status.needs-auth": "Needs account",
  "connectors.status.authorizing": "Authorizing",
  "connectors.status.ready": "Ready",
  "connectors.status.disabled": "Disabled",
  "connectors.status.error": "Needs attention",
  "connectors.feishu.name": "Feishu",
  "connectors.dingtalk.name": "DingTalk",
  "connectors.wecom.name": "WeCom",
  "connectors.feishu.description": "Manage Feishu documents, calendars and workplace collaboration.",
  "connectors.dingtalk.description": "Connect DingTalk schedules and team services.",
  "connectors.wecom.description": "Work with your team through WeCom.",
  "connectors.feishu.example": "List my Feishu calendar events for today.",
  "connectors.dingtalk.example": "List my DingTalk calendar events for today.",
  "connectors.wecom.example": "Show the available features for my WeCom account.",
  ...
  "publicAccess.token": "ngrok Authtoken",
  "publicAccess.tokenSaved": "Credential saved · enter to replace",
  "publicAccess.unconfigured": "Not configured",
  "publicAccess.disabled": "Off",
  "publicAccess.connecting": "Connecting…",
  "publicAccess.online": "Online",
  "publicAccess.reconnecting": "Reconnecting…",
  "publicAccess.failed": "Connection failed",
  "publicAccess.authError": "Authentication failed. Check your ngrok Authtoken.",
  "publicAccess.quotaError": "Your ngrok account reached a limit. Check your dashboard.",
  "publicAccess.networkError": "Network unavailable. Check this computer’s connection.",
  "publicAccess.configurationError": "Could not configure the tunnel. Check your ngrok account.",
  "publicAccess.enable": "Enable public access",
  "publicAccess.disable": "Turn off",
  "publicAccess.deleteCredential": "Remove credential",
  "publicAccess.autoStart": "Restore public access when the desktop starts",
  "publicAccess.freeNotice": "The free plan has traffic and request limits. Phones may show an ngrok notice page; tap through to continue.",
  "publicAccess.genericError": "The action failed. Please retry.",
  "publicAccess.copy": "Copy address",
  "publicAccess.pairPhone": "Connect a phone",
  "publicAccess.qrAlt": "Scan to pair this phone",
  "publicAccess.qrHint": "Valid for 5 minutes and one use. Confirm the phone on this desktop.",
  "publicAccess.pending": "Pairing request",
  "publicAccess.approve": "Approve",
  "publicAccess.reject": "Reject",
  "publicAccess.devices": "Paired devices",
  "publicAccess.revoke": "Revoke",
  "publicAccess.privacyTitle": "Security and privacy",
  "publicAccess.consent": "Agree and enable public access",
  "publicAccess.phoneIntro": "Name this browser, then request approval on your desktop.",
  "publicAccess.phonePending": "Waiting for approval on your desktop…",
  "publicAccess.phoneError": "Connection or pairing failed. Retry, or scan a new code from the desktop.",
  ...
  'settings.providers.compatibilityBudgetHint': 'Maximum output tokens requested for ordinary replies. Leave blank for automatic selection; short background requests keep their smaller budgets.',
  'settings.providers.compatibilityAdvanced': 'Advanced compatibility',
  'settings.providers.compatibilityReset': 'Reset compatibility',
  'settings.providers.compatibilityLimit': 'Known endpoint output limit',
  'settings.providers.compatibilityLimitHint': 'Set only when the provider documents a hard limit. This caps the requested budget.',
  'settings.providers.compatibilityTokenField': 'Output token field',
  'settings.providers.compatibilityAuto': 'Automatic',
  'settings.providers.compatibilityUnknown': 'Unknown',
  'settings.providers.compatibilitySupported': 'Supported',
  'settings.providers.compatibilityUnsupported': 'Unsupported',
  'settings.providers.compatibilityOmit': 'Do not send a limit',
  'settings.providers.compatibilitySampling': 'Sampling parameters',
  'settings.providers.compatibilityReasoning': 'Reasoning parameters',
  'settings.providers.compatibilityParallelTools': 'Parallel tool calls',
  'settings.providers.compatibilityStructuredOutput': 'Structured output',
  'settings.providers.compatibilityNumberError': 'Use a positive whole number or leave blank for automatic selection.',
  'settings.providers.compatibilityJsonError': 'Request compatibility must be an object with valid option values.',
  ...
  'chat.slashSearchHint': 'Type to search commands, skills and plugins',
  ...
  'workspace.panelLabel': 'Workspace',
  'workspace.tabStrip': 'Workspace tabs',
  'workspace.tabClose': 'Close {title}',
  'workspace.tabCloseCurrent': 'Close',
  'workspace.tabCloseOthers': 'Close others',
  'workspace.tabCloseRight': 'Close to the right',
  'workspace.tabCloseAll': 'Close all',
  'workspace.tabReopenClosed': 'Reopen closed tab',
  'workspace.tabMoveToBottom': 'Move to bottom panel',
  'workspace.tabMoveToSide': 'Move to workspace panel',
  'workspace.pickerCancel': 'Cancel',
  'workspace.tabAdd': 'Open in workspace',
  'workspace.tabMenu': 'Tab actions',
  'workspace.newTabTitle': 'New tab',
  'workspace.reviewTabTitle': 'Review',
  'workspace.terminalTabTitle': 'Terminal {n}',
  'workspace.bottomPanelLabel': 'Terminal panel',
  'workspace.resizeBottomPanel': 'Resize terminal panel',
  'workspace.controls.toggleBottom': 'Toggle bottom panel',
  'workspace.controls.toggleSide': 'Show/hide side panel',
  'workspace.browser.suggestions': 'Address suggestions',
  'workspace.browser.searchWeb': 'Search the web',
  'workspace.browser.visitAddress': 'Go to address',
  'workspace.controls.expand': 'Maximize workspace',
  'workspace.controls.restore': 'Restore split view',
  'workspace.controls.bottomPanel': 'Toggle bottom terminal',
  'workspace.controls.sidePanel': 'Toggle workspace',
  'workspace.launcher.label': 'Open in workspace',
  'workspace.launcher.review': 'Review',
  'workspace.launcher.terminal': 'Terminal',
  'workspace.launcher.browser': 'Browser',
  'workspace.launcher.files': 'Files',
  'workspace.launcher.reviewNeedsGit': 'Not a Git repository',
  ...
  'workspace.files.openContainingFolder': 'Open containing folder',
  'workspace.files.openTitle': 'Open file',
  'workspace.files.pickAFile': 'Choose a file from the tree',
  'workspace.files.openWith': 'Open',
  'workspace.files.watchFailed': 'File updates paused: {reason}. Refresh to retry.',
  'workspace.files.watchLimit': 'Automatic updates cover the first {count} directories. Refresh other directories manually.',
  'workspace.files.refreshFailed': 'Showing the last loaded version — refresh failed: {reason}',
  'workspace.browser.address': 'Address',
  'workspace.browser.addressPlaceholder': 'Search or enter address',
  ...
  'workspace.browser.findPlaceholder': 'Find…',
  'workspace.browser.findMatches': '{index}/{total}',
  'workspace.browser.findClose': 'Close find bar',
  'workspace.browser.print': 'Print to PDF',
  ...
  'workspace.browser.capture': 'Capture screenshot',
  'workspace.browser.pickElement': 'Pick an element',
  'workspace.browser.annotationActive': 'Annotating (Esc to exit)',
  'workspace.browser.downloads': 'Downloads',
  'workspace.browser.downloadsEmpty': 'No downloads yet',
  'workspace.browser.revealDownload': 'Open downloaded file',
  'workspace.browser.history': 'History',
  'workspace.browser.historyEmpty': 'No pages visited yet',
  'workspace.browser.closeOverlay': 'Close',
  'workspace.browser.openExternal': 'Open in system browser',
  'workspace.browser.emptyTitle': 'Start browsing',
  'workspace.browser.emptyBody': 'Enter a URL to open a page',
  'workspace.browser.loadFailed': 'Could not load {url}',
  'workspace.browser.pageCrashed': 'The page stopped responding and was reloaded.',
  'workspace.browser.pageClosed': 'The page was closed by the browser.',
  'workspace.browser.retry': 'Try again',
  'workspace.browser.unavailableTitle': 'The built-in browser needs the desktop app',
  'workspace.browser.unavailableBody': 'This build has no native browser view, so pages open in your system browser instead.',
  'workspace.terminal.restart': 'Restart terminal',
  'workspace.terminal.exited': 'This terminal has exited.',
  'workspace.review.sourceLabel': 'Comparison',
  'workspace.review.sourceUnstaged': 'Unstaged',
  'workspace.review.sourceStaged': 'Staged',
  'workspace.review.sourceUncommitted': 'All uncommitted',
  'workspace.review.sourceBranch': 'Branch: {ref}',
  'workspace.review.unstageAll': 'Unstage all',
  'workspace.review.stageHunk': 'Stage hunk',
  'workspace.review.unstageHunk': 'Unstage hunk',
  'workspace.review.historyUnavailable': 'This turn has no recorded file snapshot.',
  'workspace.review.unified': 'Unified diff',
  'workspace.review.split': 'Split diff',
  'workspace.review.enableWrap': 'Enable word wrap',
  'workspace.review.disableWrap': 'Disable word wrap',
  'workspace.review.collapseFile': 'Collapse file diff',
  'workspace.review.expandFile': 'Expand file diff',
  'workspace.review.openFile': 'Open file in tab',
  'workspace.review.sourceTurn': 'Turn changes',
  'workspace.review.sourceCommit': 'Commit {sha}',
  'workspace.review.compareBranch': 'Compare branch…',
  'workspace.review.viewCommit': 'View commit…',
  'workspace.review.branchReference': 'Branch reference',
  'workspace.review.commitReference': 'Commit reference',
  'workspace.review.refRequired': 'Enter a reference.',
  'workspace.review.refUnavailable': 'Unable to load this comparison.',
  'workspace.review.compare': 'Compare',
  'workspace.review.resolvedBase': 'Base: {ref}',
  'workspace.review.filterFiles': 'Filter files…',
  'workspace.review.changeTree': 'Changed files',
  'workspace.review.empty': 'No changes in this comparison',
  'workspace.review.stage': 'Stage file',
  'workspace.review.unstage': 'Unstage file',
  'workspace.review.revert': 'Discard changes',
  'workspace.review.stageAll': 'Stage all',
  'workspace.review.revertAll': 'Discard all',
  'workspace.review.refresh': 'Refresh',
  'workspace.review.markViewed': 'Mark as viewed',
  'workspace.review.viewed': 'Viewed',
  'workspace.review.stale': 'The working tree changed since this was loaded. Refresh and try again.',
  'workspace.review.failed': 'Git operation failed: {reason}',
  'workspace.review.revertTitle': 'Discard changes?',
  'workspace.review.revertBody': 'This discards working-tree changes in {count} file(s). A recoverable copy is saved first.',
  'workspace.review.revertUntrackedWarning': 'Untracked files are listed separately and are never discarded in bulk.',
  'workspace.review.untracked': 'Untracked',
  'workspace.review.binary': 'Binary file',
  'workspace.review.conflicted': 'Conflicted — whole-file actions only',
  'workspace.review.notGitRepo': 'This folder is not a Git repository.',
  'workspace.review.noHead': 'This repository has no commits yet.',
  'workspace.review.backupSaved': 'A recoverable copy was saved to {path}',
  'workspace.review.sourceTurnHint': 'Recorded file changes for the selected turn. Read-only; later workspace edits are excluded.',
  'workspace.review.readOnlySource': 'This comparison is read-only.',
  'workspace.review.revertDeleteTitle': 'Discard changes and delete new files?',
  'workspace.review.revertTrackedBody': 'Working-tree changes will be discarded in {count} tracked file(s). A recoverable copy is saved first.',
  'workspace.review.revertDeleteBody': '{count} untracked file(s) will be permanently deleted from disk. Git has never stored them, so only the copy saved first can bring them back.',
  'workspace.review.revertDeleteList': 'Will be deleted: {paths}',
  'workspace.review.revertDeleted': 'Deleted {count} untracked file(s). The only remaining copy is in {path}',
  'workspace.review.missingWorkdir': 'The session working directory no longer exists.',
  'workspace.review.refusedNoSnapshot': 'Load this comparison before changing files.',
  'workspace.review.diffTruncated': 'File is too large to show a diff ({size})',
...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  // Settings > Providers
  'settings.providers.title': 'Model Management',
  'settings.providers.description': 'Configure models, API endpoints, and credentials.',
  'settings.providers.addProvider': 'Add Model',
  ...
  'settings.providers.fableModel': 'Fable Model',
  ...
  'settings.providers.fableModelPlaceholder': 'Leave blank to let Claude Code choose',
  ...
  'settings.providers.supportsNestedToolResultMedia': 'Preserve nested tool result media',
  'settings.providers.nestedToolResultMediaDesc': 'Keeps images and files inside tool results when the Anthropic-compatible endpoint supports nested media. Turn this off for third-party endpoints that cannot display nested media; images and files are then lifted into standalone content blocks.',
  'settings.providers.nestedToolResultMediaUnsupported': 'Only Anthropic Messages providers can configure nested tool result media.',
  ...
  'settings.adapters.description': 'Configure IM adapters to chat with Claude Code via Telegram, Feishu, WeChat, DingTalk, WhatsApp, WeCom, QQ, or Slack. For setup details, see',
  ...
  'settings.adapters.pairingCodeHint': 'Send this code to the bot in a private chat on any connected platform. Feishu, WeChat, DingTalk, WhatsApp, WeCom and QQ require QR binding first.',
  ...
  // Settings > IM adapters — Feishu scan-to-create, WeCom, QQ, Slack
  'settings.adapters.wecom': 'WeCom',
  'settings.adapters.qq': 'QQ',
  'settings.adapters.slack': 'Slack',
  'settings.adapters.platform.wecom': 'WeCom',
  'settings.adapters.platform.qq': 'QQ',
  'settings.adapters.platform.slack': 'Slack',
  'settings.adapters.feishuQrTitle': 'Create a Feishu bot by scanning',
  'settings.adapters.feishuQrDesc': 'Scan with the Feishu mobile app. Confirming creates the bot and stores its App ID and App Secret here — no open platform setup by hand.',
  'settings.adapters.feishuStartAuth': 'Scan to Create',
  'settings.adapters.feishuRebind': 'Scan Again',
  'settings.adapters.feishuUnbindApp': 'Unbind Feishu bot',
  'settings.adapters.feishuUnbindAppConfirm': 'Unbind this Feishu bot? You will need to scan again or re-enter credentials before Feishu can send and receive messages.',
  'settings.adapters.feishuQrAlt': 'Feishu authorization QR code',
  'settings.adapters.feishuWaiting': 'Waiting for the Feishu scan...',
  'settings.adapters.feishuBindSuccess': 'Feishu bot created and bound.',
  'settings.adapters.feishuAuthFailed': 'Feishu QR authorization failed.',
  'settings.adapters.feishuUnbound': 'Feishu binding removed.',
  'settings.adapters.feishuUnbindFailed': 'Failed to unbind Feishu.',
  'settings.adapters.wecomQrTitle': 'Create a WeCom bot by scanning',
  'settings.adapters.wecomQrDesc': 'Scan with Enterprise WeChat to create an AI bot. The Bot ID and Secret are saved automatically and the adapter restarts.',
  'settings.adapters.wecomBind': 'Scan to Bind',
  'settings.adapters.wecomRebind': 'Scan Again',
  'settings.adapters.wecomUnbindBot': 'Unbind bot account',
  'settings.adapters.wecomUnbindBotConfirm': 'Unbind this WeCom bot? You will need to scan again before WeCom can send and receive messages.',
  'settings.adapters.wecomQrAlt': 'WeCom authorization QR code',
  'settings.adapters.wecomWaiting': 'Waiting for the WeCom scan...',
  'settings.adapters.wecomBindSuccess': 'WeCom bot bound.',
  'settings.adapters.wecomBindFailed': 'WeCom binding failed.',
  'settings.adapters.wecomUnbound': 'WeCom binding removed.',
  'settings.adapters.wecomUnbindFailed': 'Failed to unbind WeCom.',
  'settings.adapters.wecomAllowedUsersPlaceholder': 'e.g. zhangsan, lisi',
  'settings.adapters.wecomAllowedUsersHint': 'WeCom userids, comma separated. Leave empty to allow paired users only.',
  'settings.adapters.qqQrTitle': 'Create a QQ bot by scanning',
  'settings.adapters.qqQrDesc': 'Scan with the QQ mobile app. The AppID and AppSecret are saved automatically and the adapter restarts.',
  'settings.adapters.qqBind': 'Scan to Bind',
  'settings.adapters.qqRebind': 'Scan Again',
  'settings.adapters.qqUnbindBot': 'Unbind bot account',
  'settings.adapters.qqUnbindBotConfirm': 'Unbind this QQ bot? You will need to scan again before QQ can send and receive messages.',
  'settings.adapters.qqQrAlt': 'QQ authorization QR code',
  'settings.adapters.qqWaiting': 'Waiting for the QQ scan...',
  'settings.adapters.qqBindSuccess': 'QQ bot bound.',
  'settings.adapters.qqBindFailed': 'QQ binding failed.',
  'settings.adapters.qqUnbound': 'QQ binding removed.',
  'settings.adapters.qqUnbindFailed': 'Failed to unbind QQ.',
  'settings.adapters.qqAllowedUsersPlaceholder': 'e.g. A1B2C3D4E5F6',
  'settings.adapters.qqAllowedUsersHint': 'QQ user openids, comma separated. Leave empty to allow paired users only.',
  'settings.adapters.slackCreateAppTitle': 'Create a Slack app',
  'settings.adapters.slackCreateAppDesc': 'Slack has no scan flow, so it uses an app manifest instead: the button below opens the create page with the scopes and Socket Mode already filled in.',
  'settings.adapters.slackCreateAppAction': 'Create app from manifest',
  'settings.adapters.slackStepCreate': 'Open the create page, review the manifest and create the app.',
  'settings.adapters.slackStepInstall': 'Install the app into your workspace and copy the Bot Token (starts with xoxb-).',
  'settings.adapters.slackStepTokens': 'Under Basic Information generate an App-Level Token (starts with xapp-, scope connections:write) and paste both below.',
  'settings.adapters.slackManifestToggle': 'Show the app manifest JSON',
  'settings.adapters.slackManifestFailed': 'Could not load the Slack app manifest.',
  'settings.adapters.slackBotToken': 'Bot Token',
  'settings.adapters.slackBotTokenPlaceholder': 'starts with xoxb-',
  'settings.adapters.slackAppToken': 'App-Level Token',
  'settings.adapters.slackAppTokenPlaceholder': 'starts with xapp-, needs connections:write',
  'settings.adapters.slackAllowedUsersPlaceholder': 'e.g. U01ABCDEF, U02GHIJKL',
  'settings.adapters.slackUnbindApp': 'Unbind Slack app',
  'settings.adapters.slackUnbound': 'Slack binding removed.',
  'settings.adapters.slackUnbindFailed': 'Failed to unbind Slack.',
  'settings.adapters.slackUnbindAppConfirm': 'Unbind this Slack app? You will need to re-enter the tokens before Slack can send and receive messages.',
  ...
  'settings.agents.form.modelDefaultDescription': 'Use the default shipped with this Claude Code build.',
  ...
  'settings.agents.overrideHint': 'Only the model and effort can be changed. The system prompt, tools and color are fixed by Claude Code.',
  ...
  'settings.about.community': 'Join the cc-haha group',
  'settings.about.communityDesc': 'A WeCom group. Scan the code to join; conversation there is mostly in Chinese',
  'settings.about.communityHint': 'Scan with WeChat or WeCom to join',
  'settings.about.communityQrAlt': 'cc-haha WeCom user group QR code',
  ...
  'settings.general.sessionRetentionTitle': 'Session History',
  'settings.general.sessionRetentionDescription': 'How long transcripts are kept on this device. Lowering the value deletes older sessions right away, so it asks for confirmation first.',
  'settings.general.sessionRetentionLabel': 'Keep session history for',
  'settings.general.sessionRetentionCurrent': 'Current: {days} days',
  'settings.general.sessionRetentionCurrentOff': 'Current: not saved',
  'settings.general.sessionRetentionUnit': 'days',
  'settings.general.sessionRetentionHint': 'Default is 365 days. Setting this to 0 stops recording session content and deletes every existing transcript.',
  'settings.general.sessionRetentionRequired': 'Enter a number of days.',
  'settings.general.sessionRetentionRange': 'Enter a whole number from 0 to {max}.',
  'settings.general.sessionRetentionSave': 'Save',
  'settings.general.sessionRetentionSaved': 'Retention updated. {count} old session files removed.',
  'settings.general.sessionRetentionSavedPartial': 'Retention updated. {count} old session files removed, {errors} could not be removed.',
  'settings.general.sessionRetentionConfirmTitle': 'Change session history retention?',
  'settings.general.sessionRetentionConfirmDelete': 'Sessions older than {days} days will be permanently deleted. This cannot be undone.',
  'settings.general.sessionRetentionConfirmDisable': 'Setting this to 0 stops recording new session content and permanently deletes every existing transcript. This cannot be undone.',
  'settings.general.sessionRetentionPreview': '{count} files currently match this cutoff.',
  'settings.general.sessionRetentionPreviewUnavailable': 'Could not count matching files. You can still confirm.',
  'settings.general.sessionRetentionConfirmAction': 'Delete and save',
  ...
  'settings.general.agentTeamsTitle': 'Agent Teams',
  'settings.general.agentTeamsDescription': 'Let multiple agents divide tasks and collaborate as a team.',
  'settings.general.agentTeamsEnabled': 'Enable Agent Teams',
  'settings.general.agentTeamsHint': 'Applies to new sessions. Restart the app to apply changes to existing sessions.',
  'settings.general.agentTeamsSaveFailed': 'Failed to save Agent Teams settings. Please try again.',
  ...
  'settings.general.networkTimeoutHint': 'Applies to provider requests, streaming first responses, and provider connection tests. Minimum 30 seconds; for local models with long thinking times, set 14400 seconds (4 hours) or longer. Raising it also extends the overall time limit for a single streamed response (never below 600 seconds).',
  ...
  'contextIndicator.remaining': 'Remaining',
  ...
  'contextIndicator.breakdown': 'Breakdown',
  'contextIndicator.sessionCacheHit': 'Cache hit',
  'contextIndicator.sessionSpeed': 'Speed',
  'contextIndicator.sessionCost': 'Session cost',
  'contextIndicator.sessionSpeedUnit': 'tok/s',
  ...
  'agentActivity.loading': 'Loading tool activity…',
  'agentActivity.failed': 'Could not load this run’s tool activity.',
  'agentActivity.retry': 'Retry',
  'agentActivity.truncated': 'Showing the start and end of this run. Open the run for the full trace.',
  ...
  'session.historyTooLarge': 'This session history is too large to load here.',
  ...
  'browser.selection.cleanupFailed': 'Could not stop or revert the extra selection: {reason}',
