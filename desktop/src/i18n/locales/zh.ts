...
export const zh: Record<TranslationKey, string> = {
  ...
  "extensions.managedSkillHint": "配套技能随所属插件管理；本地与项目技能请在对应目录管理。",
  "extensions.searchPlugins": "搜索插件",
  "extensions.searchSkills": "搜索精选技能",
  "extensions.pluginsSubtitle": "连接常用服务，或为助手添加创作与开发工具。",
  "extensions.filter": "筛选扩展",
  "extensions.categories": "扩展分类",
  "extensions.empty": "没有匹配的扩展",
  "chat.references": "引用",
  "chat.referencePlugins": "插件",
  "chat.referenceSkills": "技能",
  "chat.referenceFiles": "文件",
  "chat.referencesLoadFailed": "无法加载技能和插件",
  "chat.referencesEmpty": "没有匹配的引用",
  "chat.referenceDescription": "描述",
  "chat.referenceSource": "来源",
  "chat.referenceDetails": "引用详情",
  "sidebar.extensions": "技能·连接器",
  "extensions.sections": "市场分类",
  "extensions.plugins": "插件",
  "extensions.skills": "技能",
  "extensions.featuredSkills": "精选技能",
  "connectors.airtable.description": "查询数据表、记录与团队协作资料。",
  "connectors.airtable.example": "查看 Airtable 中最近更新的项目记录。",
  "connectors.airtable.name": "Airtable",
  "connectors.airtable.requirements": "通过浏览器授权目标工作区或数据表；企业管理员可能限制客户端访问。",
  "connectors.algorithmic-art.description": "用 p5.js 创建可调参数的算法艺术与交互画面。",
  "connectors.algorithmic-art.example": "制作一个可调整颜色与密度的流场艺术页面。",
  "connectors.algorithmic-art.name": "生成式艺术",
  "connectors.algorithmic-art.requirements": "包含示例模板和参考代码。预览需要浏览器及 p5.js 资源；安装不执行脚本，也不调用生成模型。",
  "connectors.atlassian.description": "检索 Jira、Confluence 与项目协作资料。",
  "connectors.atlassian.example": "汇总 Jira 中分配给我的问题并关联 Confluence 资料。",
  "connectors.atlassian.name": "Atlassian",
  "connectors.atlassian.requirements": "需要 Atlassian Cloud 账号及产品权限，通过浏览器授权；部分产品和操作需要管理员启用。",
  "connectors.bazhuayu.description": "查找采集模板、查看云任务状态与已采集数据。",
  "connectors.bazhuayu.example": "列出八爪鱼数据中心支持的平台，不创建或启动采集任务。",
  "connectors.bazhuayu.name": "八爪鱼",
  "connectors.bazhuayu.requirements": "需要八爪鱼账户中心 API Key；仅支持云端采集能力，运行任务可能消耗余额，部分模板需指定套餐。",
  "connectors.canvas-design.description": "创作海报、静态视觉作品与 PDF 画布，附带字体。",
  "connectors.canvas-design.example": "设计一张科技活动海报，并导出为 PDF。",
  "connectors.canvas-design.name": "海报与视觉画布",
  "connectors.canvas-design.requirements": "安装完整设计技能、字体及对应许可。生成图像或 PDF 需要 Python 和相应绘图依赖；不会自动安装这些运行库。",
  "connectors.clickup.description": "查找项目、任务和团队工作资料。",
  "connectors.clickup.example": "列出 ClickUp 中分配给我的未完成任务。",
  "connectors.clickup.name": "ClickUp",
  "connectors.clickup.requirements": "需要 ClickUp 账号及工作区权限，通过浏览器授权；服务仍为公开测试版。",
  "connectors.cloudflare.description": "查询和管理网站、网络及云开发资源。",
  "connectors.cloudflare.example": "查看我的 Cloudflare 资源并汇总当前配置。",
  "connectors.cloudflare.name": "Cloudflare",
  "connectors.cloudflare.requirements": "需要用户或账户 API Token；按所需资源授予权限，部署和配置变更需明确任务授权。",
  "connectors.drawio.description": "生成可编辑的架构图、流程图和关系图。",
  "connectors.drawio.example": "把这段系统说明整理成可编辑的 draw.io 架构图。",
  "connectors.drawio.name": "draw.io 图表",
  "connectors.drawio.requirements": "可直接编写 .drawio XML 文件；Mermaid 转换、自动布局及图片导出需要 draw.io 桌面版 CLI。安装技能不会安装桌面应用。",
  "connectors.firecrawl.description": "搜索网页、提取页面并整理研究资料。",
  "connectors.firecrawl.example": "搜索关于浏览器自动化的技术资料并保留来源。",
  "connectors.firecrawl.name": "Firecrawl",
  "connectors.firecrawl.requirements": "需要 Firecrawl API Key；调用按账户额度计费，密钥通过安全请求头发送。",
  "connectors.frontend-design.description": "为网页和应用编写具有清晰视觉层次的前端界面。",
  "connectors.frontend-design.example": "为我的知识管理应用设计并实现首页。",
  "connectors.frontend-design.name": "前端界面设计",
  "connectors.frontend-design.requirements": "安装 Anthropic 的前端设计技能。预览与构建需要目标项目的前端依赖和运行环境；本技能不提供托管或图片生成服务。",
  "connectors.hyperframes.description": "用 HTML 和动画代码制作视频、字幕与产品演示。",
  "connectors.hyperframes.example": "用 HyperFrames 为产品制作一段 20 秒的介绍视频。",
  "connectors.hyperframes.name": "HyperFrames",
  "connectors.hyperframes.requirements": "安装固定版本的 5 项完整技能与参考资料，不安装渲染器。实际渲染需要 Node.js 22+、HyperFrames CLI 与 FFmpeg；语音和在线素材服务可能需要单独配置及付费。",
  "connectors.intercom.description": "检索客户对话、联系人和帮助中心资料。",
  "connectors.intercom.example": "查找最近客户反馈中的常见问题并汇总。",
  "connectors.intercom.name": "Intercom",
  "connectors.intercom.requirements": "目前仅支持美国托管工作区；需要具有联系人、对话和文章权限的访问令牌。",
  "connectors.jufa.description": "检索司法案例，辅助类案研究与裁判观点整理。",
  "connectors.jufa.example": "检索建设工程合同纠纷案例，整理案号、法院及裁判观点并注明出处。",
  "connectors.jufa.name": "聚法案例",
  "connectors.jufa.requirements": "需要聚法智能体数据平台 API Key；本连接器接入案例研究服务，法规等其他专题需另行接入，数据受套餐与调用额度限制。",
  "connectors.kuaicha.description": "检索企业工商、经营和风险资料，辅助主体核验。",
  "connectors.kuaicha.example": "查询我指定企业的工商登记与经营异常信息，并区分已查到和缺失的数据。",
  "connectors.kuaicha.name": "同花顺快查",
  "connectors.kuaicha.requirements": "需要快查开放平台 API Key；服务仅限大陆 IP 访问，查询受账号额度与权限限制。",
  "connectors.listinggood.description": "分析亚马逊商品文案，辅助合规检查和内容优化。",
  "connectors.listinggood.example": "检查我提供的亚马逊商品文案，给出合规与可读性改进建议。",
  "connectors.listinggood.name": "ListingGood",
  "connectors.listinggood.requirements": "需要 ListingGood 国内站 API Key；国内站与海外站密钥不通用，付费工具按账号额度执行。",
  "connectors.mcp-builder.description": "构建与评估 MCP 服务，提供 TypeScript 和 Python 参考。",
  "connectors.mcp-builder.example": "为我们的内部知识库设计一个 MCP 服务。",
  "connectors.mcp-builder.name": "MCP 开发工具包",
  "connectors.mcp-builder.requirements": "包含协议设计参考和评估脚本。开发需 Node.js 或 Python 及 MCP SDK；模型评估、第三方 API 使用需用户自行配置凭据，可能产生费用。",
  "connectors.miro.description": "查阅协作白板，整理设计与讨论内容。",
  "connectors.miro.example": "总结我指定 Miro 白板中的主要想法和待办。",
  "connectors.miro.name": "Miro",
  "connectors.miro.requirements": "需要 Miro 账号和白板访问权限，组织管理员可能需要启用 MCP。",
  "connectors.neon.description": "查看数据库项目、分支与开发数据结构。",
  "connectors.neon.example": "查看 Neon 开发项目的数据库结构，不修改数据。",
  "connectors.neon.name": "Neon",
  "connectors.neon.requirements": "需要 Neon API Key 和项目权限；官方建议优先用于开发和测试数据库。",
  "connectors.obsidian.description": "编辑 Markdown 笔记、Canvas 画布与 Bases 数据视图。",
  "connectors.obsidian.example": "把这些项目笔记整理为 Obsidian Canvas 关系图。",
  "connectors.obsidian.name": "Obsidian 工具包",
  "connectors.obsidian.requirements": "本地文件编辑无需云端账号。CLI 操作需要安装并运行 Obsidian；网页内容提取等可选功能需要相应 CLI。本安装仅提供技能文件。",
  "connectors.postman.description": "查询 API 工作区、集合与开发资料。",
  "connectors.postman.example": "查找 Postman 工作区中与用户登录相关的 API。",
  "connectors.postman.name": "Postman",
  "connectors.postman.requirements": "使用美国区域 Postman 账号浏览器授权；此条目采用精简工具集，欧盟区域需单独 API Key 配置。",
  "connectors.qcc.description": "检索企业主体信息，核验工商登记与关联资料。",
  "connectors.qcc.example": "查询我指定企业的工商登记信息，并列出来源。",
  "connectors.qcc.name": "企查查",
  "connectors.qcc.requirements": "需要企查查 Agent 平台 API Key；本连接器仅接入企业基础信息服务，其他专题需另行接入，查询受账号权限与积分限制。",
  "connectors.qingflow.description": "查询轻流工作区应用与业务数据，辅助流程协作。",
  "connectors.qingflow.example": "查看轻流工作区中我有权限的应用，并整理待处理事项。",
  "connectors.qingflow.name": "轻流",
  "connectors.qingflow.requirements": "需要轻流账号，通过浏览器授权；可访问范围继承工作区和应用权限，具体能力受套餐限制。",
  "connectors.qveris.description": "发现和查阅可调用的数据工具，辅助信息研究。",
  ...
  "connectors.render.requirements": "需要 Render API Key；先指定工作区。密钥可访问本人所属工作区，部署等写操作需明确任务授权。",
  "connectors.sorftime.description": "查询跨境电商市场、商品与关键词数据。",
  "connectors.sorftime.example": "查询我指定商品的市场趋势并注明站点、时间范围与数据来源。",
  "connectors.sorftime.name": "Sorftime",
  "connectors.sorftime.requirements": "需要开通 Sorftime MCP 服务并获取 Account-SK；平台、站点及查询次数受所购服务与额度限制。",
  "connectors.todoist.description": "查看待办、项目和个人任务安排。",
  "connectors.todoist.example": "列出 Todoist 中今天到期和已经逾期的任务。",
  "connectors.todoist.name": "Todoist",
  "connectors.todoist.requirements": "需要 Todoist 账号，通过浏览器授权任务和项目访问权限。",
  "connectors.variflight.description": "查询航班动态、机场信息与航旅行程。",
  "connectors.variflight.example": "查询我指定航班的计划时间与当前动态，并注明查询时间。",
  "connectors.variflight.name": "飞常准",
  "connectors.variflight.requirements": "需要在飞常准 MCP 开放平台登录并生成 MCP Key；个人行程须有相应账号权限，数据与调用额度按服务商规定提供。",
  "connectors.webapp-testing.description": "使用 Playwright 检查本地网页、交互行为与截图。",
  "connectors.webapp-testing.example": "检查本地应用的登录表单校验和页面布局。",
  "connectors.webapp-testing.name": "网页测试工具包",
  "connectors.webapp-testing.requirements": "包含测试技能、Python 辅助脚本及示例。实际运行需要 Python、Playwright 和浏览器，以及待测应用；安装不会自动下载浏览器。",
  "connectors.webflow.description": "读取网站结构、CMS 内容与设计资料。",
  "connectors.webflow.example": "查看我的 Webflow 网站中的 CMS 集合和字段。",
  "connectors.webflow.name": "Webflow",
  "connectors.webflow.requirements": "需要至少一个可访问站点的 Webflow 账号；浏览器授权自动安装 MCP Bridge App，设计器操作需桥接应用连接。",
  "connectors.xmind.description": "读取与整理在线思维导图，辅助规划和知识归纳。",
  "connectors.xmind.example": "列出 Xmind 最近打开的在线思维导图，读取我选择的导图并总结。",
  "connectors.xmind.name": "Xmind",
  "connectors.xmind.requirements": "需要 Xmind 国内版账号，通过浏览器授权；仅访问已授权团队的在线导图，编辑能力受账号套餐限制。",
  "connectors.toolsRemoveInfo": "移除这个工具插件及其技能文件。已有任务和产出文件会保留。",
  "connectors.collection": "目录类型",
  "connectors.services": "服务连接器",
  "connectors.tools": "工具插件",
  "connectors.region": "服务地区",
  "connectors.region.all": "全部地区",
  "connectors.region.china": "国内服务",
  "connectors.region.global": "全球服务",
  "connectors.toolKind": "工具插件",
  "connectors.toolsSubtitle": "为任务添加专用技能与工作方法。",
  "connectors.skillsLoaded": "技能已加载",
  "connectors.skillsPending": "技能待加载",
  "connectors.verifySkills": "验证技能",
  "connectors.skillsRuntimeInfo": "已添加的是技能包。任务所需的 Node.js、命令行工具或其他运行环境仍需单独满足；技能加载成功不代表这些环境已安装。",
  "connectors.saveAndVerify": "保存并验证",
  "connectors.needsService": "待连接服务",

  "connectors.tencent-docs.name": "腾讯文档",
  "connectors.tencent-docs.description": "读取和整理在线文档、表格与协作资料。",
  "connectors.tencent-docs.example": "查找腾讯文档中与项目计划相关的资料。",
  "connectors.tencent-docs.requirements": "需要腾讯文档 MCP 访问令牌；仅可访问账号已有权限的文档。",
  "connectors.jinshuju.name": "金数据",
  "connectors.jinshuju.description": "查询表单与收集的数据，辅助统计和整理。",
  "connectors.jinshuju.example": "查看金数据中最近收集的问卷结果并整理摘要。",
  "connectors.jinshuju.requirements": "需要金数据账号，通过浏览器授权表单与数据访问权限。",
  "connectors.pkulaw.name": "北大法宝",
  "connectors.pkulaw.description": "检索法律法规，追溯法律条文和原始出处。",
  "connectors.pkulaw.example": "检索与劳动合同试用期相关的法律条文并注明出处。",
  "connectors.pkulaw.requirements": "需要北大法宝 MCP access token 及相应资料权限；检索结果需核对现行有效性。",
  "connectors.datayes.name": "通联数据",
  "connectors.datayes.description": "查询股票行情与金融市场数据，辅助研究。",
  "connectors.datayes.example": "查询我指定股票的历史行情并整理数据来源。",
  "connectors.datayes.requirements": "需要通联数据 MCP Token；数据范围受账号权限和额度限制，企业账户需按服务商要求核验。",
  "connectors.tencent-search.name": "腾讯云智能搜索",
  "connectors.tencent-search.description": "检索网络资料，为研究提供可追溯信息。",
  "connectors.tencent-search.example": "搜索国内低空经济产业发展资料，并整理官方来源。",
  "connectors.tencent-search.requirements": "需要开通腾讯云 WSA 服务并获取 API Key，调用按账号额度与计费规则执行。",
  "connectors.amap.name": "高德地图",
  "connectors.amap.description": "搜索地点、规划路线，查询天气与出行信息。",
  "connectors.amap.example": "帮我规划从杭州东站到西湖的公共交通路线。",
  "connectors.amap.requirements": "需要高德开放平台 Web 服务 API Key；地图服务按账号权限和配额提供。",
  "connectors.baidu-maps.name": "百度地图",
  "connectors.baidu-maps.description": "地址解析、周边检索与路线规划。",
  "connectors.baidu-maps.example": "查询上海虹桥站附近的酒店和交通方式。",
  "connectors.baidu-maps.requirements": "需要百度地图开放平台服务器端 AK 及对应服务权限。",
  "connectors.tencent-maps.name": "腾讯地图",
  "connectors.tencent-maps.description": "查询位置、距离和路线，辅助出行安排。",
  "connectors.tencent-maps.example": "比较广州南站到广州塔的公共交通与驾车路线。",
  "connectors.tencent-maps.requirements": "需要腾讯位置服务 Key，并开通 WebServiceAPI 权限与配额。",
  "connectors.zhipu-search.name": "智谱联网搜索",
  "connectors.zhipu-search.description": "检索中文网页、新闻与实时信息，保留来源。",
  "connectors.zhipu-search.example": "搜索近期国内新能源汽车政策，并列出原始来源。",
  "connectors.zhipu-search.requirements": "需要 GLM Coding Plan 套餐 API Key；团队套餐密钥与平台通用密钥不通用。",
  "connectors.notion.name": "Notion",
  "connectors.notion.description": "搜索工作区资料，整理页面与项目知识。",
  "connectors.notion.example": "查找 Notion 中最近的项目周报并总结进展。",
  "connectors.notion.requirements": "需要 Notion 账号，浏览器授权后仅能访问该账号允许的工作区内容。",
  "connectors.linear.name": "Linear",
  "connectors.linear.description": "查询问题、项目与迭代，跟进团队任务。",
  "connectors.linear.example": "列出 Linear 中分配给我的未完成问题。",
  "connectors.linear.requirements": "需要 Linear 工作区账号及相应项目访问权限，通过浏览器授权。",
  "connectors.github.name": "GitHub",
  "connectors.github.description": "检索仓库代码、Issue 和 Pull Request。",
  "connectors.github.example": "查看我的 GitHub 仓库中等待评审的 Pull Request。",
  "connectors.github.requirements": "需要 GitHub Personal Access Token；按所需仓库与操作授予权限，组织策略仍然适用。",
  "connectors.context7.name": "Context7",
  "connectors.context7.description": "查阅软件库的最新文档与用法示例。",
  "connectors.context7.example": "查找 React useEffect 的官方文档和清理函数示例。",
  "connectors.context7.requirements": "使用官方匿名访问额度；不保证无限调用，额度不足时服务会返回限制。",
  "connectors.sentry.name": "Sentry",
  "connectors.sentry.description": "查看异常、追踪问题与应用运行信息。",
  "connectors.sentry.example": "总结 Sentry 中最近一天新出现的错误。",
  "connectors.sentry.requirements": "需要 Sentry 账号及组织、项目权限，通过浏览器授权。",
  "connectors.tavily.name": "Tavily",
  "connectors.tavily.description": "搜索网页、提取内容，支持资料研究。",
  "connectors.tavily.example": "研究开源向量数据库的主要差异，并给出来源。",
  "connectors.tavily.requirements": "需要 Tavily API Key，调用按该账号订阅与额度计费。",
  "connectors.exa.name": "Exa",
  "connectors.exa.description": "搜索网页与代码资料，发现相关信息。",
  "connectors.exa.example": "寻找关于分布式系统可观测性的技术文章。",
  "connectors.exa.requirements": "使用官方基础匿名访问额度；可用工具和次数由服务商决定。",
  "connectors.supabase.name": "Supabase",
  "connectors.supabase.description": "查看项目、数据库结构和开发资料。",
  "connectors.supabase.example": "查看 Supabase 项目的数据表结构，不修改数据。",
  "connectors.supabase.requirements": "需要 Supabase 账号及目标组织、项目权限；数据库写操作仍需明确任务授权。",
  "connectors.huggingface.name": "Hugging Face",
  "connectors.huggingface.description": "发现模型、数据集与机器学习研究资源。",
  "connectors.huggingface.example": "寻找适合中文文本分类的公开模型与数据集。",
  "connectors.huggingface.requirements": "需要 Hugging Face 访问令牌；检索建议仅授予 read 权限，计算任务可能另行收费。",
  "connectors.canva.name": "Canva",
  "connectors.canva.description": "搜索和整理设计素材，协作处理设计内容。",
  "connectors.canva.example": "查找 Canva 中最近的品牌设计素材。",
  "connectors.canva.requirements": "每位用户使用自己的 Canva 账号授权；部分能力受订阅和团队权限限制。",
  "connectors.figma.name": "Figma",
  "connectors.figma.description": "读取设计上下文，理解组件与界面结构。",
  "connectors.figma.example": "分析我提供的 Figma 设计链接中的组件结构。",
  "connectors.figma.requirements": "需要 Figma 账号授权；设计访问权限、席位和套餐决定可用工具及次数。",
  "connectors.stripe.name": "Stripe",
  "connectors.stripe.description": "查询客户、账单和支付业务资料。",
  "connectors.stripe.example": "查看 Stripe 中最近的账单概况，不创建支付或退款。",
  "connectors.stripe.requirements": "需要 Stripe 账号授权。该官方服务为预览版；付款、退款等写操作需要明确任务授权。",
  "connectors.category.legal": "法律检索",
  "connectors.connectService": "连接服务",
  "connectors.officialMcp": "官方 MCP 服务",

  "connectors.categories": "服务分类",
  "connectors.allCategories": "精选",
  "connectors.category.office": "办公协作",
  "connectors.category.development": "开发工具",
  "connectors.category.search": "搜索",
  "connectors.category.maps": "地图出行",
  "connectors.category.data": "数据分析",
  "connectors.category.design": "设计创作",
  "connectors.category.productivity": "效率工具",
  "connectors.category.finance": "金融",
  "connectors.kind": "连接器",
  "connectors.loadFailed": "暂时无法完成操作",
  "connectors.emptyAdded": "添加常用服务后，就能在这里管理账号与连接状态。",
  "connectors.emptySearch": "换个关键词，或查看其他分类。",
  "connectors.resetFilters": "查看全部",
  "connectors.configuration": "连接配置",
  "connectors.configurationHint": "留空沿用已保存配置。填写新配置后，点击“保存并验证”验证连接。",
  "connectors.fieldRequired": "请填写此项",
  "connectors.capabilities": "支持的操作",
  "connectors.remoteExample": "请使用 {name} 查询我可以访问的信息。",
  "connectors.remoteRequirements": "请准备服务账号及所需访问权限；具体操作以服务商授予的权限为准。",

  "connectors.phase.installing-plugin": "安装配套技能",
  "connectors.phase.checking": "检查账号连接",
  "connectors.phase.enabling-plugin": "启用配套技能",
  "connectors.phase.refreshing-sessions": "刷新任务能力",
  "connectors.phase.verifying-runtime": "检查本地运行环境",
  "connectors.phase.persistence": "保存连接状态",
  "connectors.phase.cancelling": "取消操作",
  "connectors.feishu.requirements": "需要飞书用户账号及日历访问权限；实际能力取决于账号与应用获授的权限。",
  "connectors.dingtalk.requirements": "需要钉钉 OAuth 登录及企业管理员授予日历权限；登录成功不代表具备所有服务权限。",
  "connectors.wecom.requirements": "需要配置企业微信机器人或用户身份及日历权限；可用操作取决于所选身份获授的权限。",

  "connectors.update": "更新",
  "connectors.updateAvailable": "可更新至",
  "connectors.currentAccount": "当前服务账号",

  "connectors.phase.downloading": "下载运行文件",
  "connectors.phase.extracting": "解压运行文件",
  "connectors.phase.verifying": "校验运行文件",
  "connectors.phase.awaiting-authorization": "等待账号授权",
  "connectors.phase.configuring-account": "配置账号",
  "connectors.phase.authorizing": "正在授权",
  "connectors.phase.failed": "失败阶段",
  "connectors.phase.skillsInfo": "安装后提供对应服务的操作技能。",

  'connectors.status.configured': '本机已配置',
  'connectors.localVerification': '首次任务调用时验证服务权限。',
  "sidebar.connectors": "连接器",
  "connectors.subtitle": "连接常用办公服务，让技能获得真实的服务能力。",
  "connectors.filter": "筛选连接器",
  "connectors.all": "全部",
  "connectors.added": "已添加",
  "connectors.search": "搜索连接器",
  "connectors.clear": "清除搜索",
  "connectors.retry": "重试",
  "connectors.loading": "加载中…",
  "connectors.empty": "没有匹配的连接器",
  "connectors.details": "查看详情",
  "connectors.start": "开始使用",
  "connectors.account": "账号",
  "connectors.noAccount": "尚未验证账号",
  "connectors.platforms": "支持平台",
  "connectors.source": "来源",
  "connectors.version": "版本",
  "connectors.skills": "配套技能插件",
  "connectors.homepage": "项目主页",
  "connectors.example": "示例",
  "connectors.waiting": "正在处理，请完成授权后等待状态更新。",
  "connectors.authorize": "打开授权页面",
  "connectors.confirm": "确认操作",
  "connectors.continue": "继续",
  "connectors.shared": "此连接器会复用本机该 CLI 的账号凭据。连接或切换账号会影响其他使用同一 CLI 的应用，请确认后继续。",
  "connectors.isolated": "账号凭据独立保存在本应用中。",
  "connectors.removeInfo": "移除本应用管理的连接器，保留共享账号凭据。",
  "connectors.invalidUrl": "授权链接格式不正确",
  "connectors.openFailed": "无法打开链接，请重试",
  "connectors.startFailed": "无法创建任务，请重试",
  "connectors.unsupported": "当前平台不支持",
  "connectors.action.prepare": "添加",
  "connectors.action.authenticate": "连接账号",
  "connectors.action.check": "检查连接",
  "connectors.action.deactivate": "停用",
  "connectors.action.remove": "移除",
  "connectors.status.not-installed": "未添加",
  "connectors.status.preparing": "准备中",
  "connectors.status.needs-auth": "待连接账号",
  "connectors.status.authorizing": "授权中",
  "connectors.status.ready": "可用",
  "connectors.status.disabled": "已停用",
  "connectors.status.error": "需要处理",
  "connectors.feishu.name": "飞书",
  "connectors.dingtalk.name": "钉钉",
  "connectors.wecom.name": "企业微信",
  "connectors.feishu.description": "管理飞书文档、日历与办公协作。",
  "connectors.dingtalk.description": "连接钉钉的日程与团队办公服务。",
  "connectors.wecom.description": "使用企业微信开展团队协作。",
  "connectors.feishu.example": "请列出我在飞书中今天的日程。",
  "connectors.dingtalk.example": "请查询我在钉钉中今天的日程。",
  "connectors.wecom.example": "请查看我的企业微信账号可用的功能。",
  ...
  "publicAccess.tokenSaved": "凭据已保存，输入可替换",
  "publicAccess.unconfigured": "未配置",
  "publicAccess.disabled": "已关闭",
  "publicAccess.connecting": "连接中…",
  "publicAccess.online": "在线",
  "publicAccess.reconnecting": "重连中…",
  "publicAccess.failed": "连接失败",
  "publicAccess.authError": "认证失败，请检查 ngrok Authtoken。",
  "publicAccess.quotaError": "ngrok 账户已达到限制，请查看控制台。",
  "publicAccess.networkError": "网络不可用，请检查电脑的网络连接。",
  "publicAccess.configurationError": "无法配置隧道，请检查 ngrok 账户。",
  "publicAccess.enable": "开启公网访问",
  "publicAccess.disable": "关闭公网访问",
  "publicAccess.deleteCredential": "删除凭据",
  "publicAccess.autoStart": "随桌面启动恢复公网访问",
  "publicAccess.freeNotice": "免费套餐有流量和请求限制。手机可能显示 ngrok 提示页，点击继续即可访问。",
  "publicAccess.genericError": "操作失败，请重试。",
  "publicAccess.copy": "复制地址",
  "publicAccess.pairPhone": "连接手机",
  "publicAccess.qrAlt": "扫码配对手机",
  "publicAccess.qrHint": "二维码 5 分钟内有效，仅可使用一次。请在桌面确认手机配对。",
  "publicAccess.pending": "配对请求",
  "publicAccess.approve": "允许配对",
  "publicAccess.reject": "拒绝",
  "publicAccess.devices": "已配对设备",
  "publicAccess.revoke": "撤销",
  "publicAccess.privacyTitle": "安全与隐私说明",
  "publicAccess.consent": "同意并开启公网访问",
  "publicAccess.phoneIntro": "为此浏览器命名，然后在桌面确认配对。",
  "publicAccess.phonePending": "等待桌面确认配对…",
  "publicAccess.phoneError": "连接或配对失败。请重试，或在桌面生成新的二维码。",
  ...
  'sidebar.openInFileManager.darwin': '在“访达”中打开',
  'sidebar.openInFileManager.win32': '在文件资源管理器中打开',
  'sidebar.openInFileManager.linux': '在文件管理器中打开',
  'sidebar.openInFileManager.default': '在文件管理器中打开',
  'sidebar.openInFileManagerFailed': '无法在文件管理器中打开项目。',
  'sidebar.openInFileManagerUnavailable': '没有可用的文件管理器。',
  ...
  'sidebar.sessionNeedsAttention': '等待你确认',
  'sidebar.taskView': '任务视图',
  'sidebar.tasks': '任务',
  'sidebar.taskGroup.running': '进行中',
  'sidebar.taskGroup.today': '今天',
  'sidebar.taskGroup.yesterday': '昨天',
  'sidebar.taskGroup.last7Days': '过去 7 天',
  'sidebar.taskGroup.last30Days': '过去 30 天',
  ...
  'openWith.openInDefaultTarget': '用 {target} 打开（默认）',
  'openWith.openFailed': '无法打开 {name}，文件可能已被移动或删除。',
  'openWith.revealIn.darwin': '在“访达”中显示',
  'openWith.revealIn.win32': '在文件资源管理器中显示',
  'openWith.revealIn.linux': '在文件管理器中显示',
  'openWith.revealIn.default': '在文件管理器中显示',
  ...
  'workbench.close': '关闭',
  'workspace.panelLabel': '工作区',
  'workspace.tabStrip': '工作区标签',
  'workspace.tabClose': '关闭 {title}',
  'workspace.tabCloseCurrent': '关闭',
  'workspace.tabCloseOthers': '关闭其他',
  'workspace.tabCloseRight': '关闭右侧',
  'workspace.tabCloseAll': '关闭全部',
  'workspace.tabReopenClosed': '重新打开已关闭标签',
  'workspace.tabMoveToBottom': '移到底部面板',
  'workspace.tabMoveToSide': '移到工作区面板',
  'workspace.pickerCancel': '取消',
  'workspace.tabAdd': '在工作区中打开',
  'workspace.tabMenu': '标签页操作',
  'workspace.newTabTitle': '新标签页',
  'workspace.reviewTabTitle': '审查',
  'workspace.terminalTabTitle': '终端 {n}',
  'workspace.bottomPanelLabel': '终端面板',
  'workspace.resizeBottomPanel': '调整终端面板高度',
  'workspace.controls.toggleBottom': '切换底部面板显示',
  'workspace.controls.toggleSide': '显示/隐藏侧边面板',
  'workspace.browser.suggestions': '地址建议',
  'workspace.browser.searchWeb': '搜索网页',
  'workspace.browser.visitAddress': '打开网址',
  'workspace.controls.expand': '工作区占满',
  'workspace.controls.restore': '恢复分栏',
  'workspace.controls.bottomPanel': '显示/隐藏底部终端',
  'workspace.controls.sidePanel': '显示/隐藏工作区',
  'workspace.launcher.label': '在工作区中打开',
  'workspace.launcher.review': '审查',
  'workspace.launcher.terminal': '终端',
  'workspace.launcher.browser': '浏览器',
  'workspace.launcher.files': '文件',
  'workspace.launcher.reviewNeedsGit': '不是 Git 仓库',
  'workspace.files.filter': '筛选文件…',
  'workspace.files.tree': '文件树',
  ...
  'workspace.files.openContainingFolder': '打开所在文件夹',
  'workspace.files.openTitle': '打开文件',
  'workspace.files.pickAFile': '从右侧文件树中选择文件',
  'workspace.files.openWith': '打开',
  'workspace.files.watchFailed': '文件自动更新已暂停：{reason}。可刷新重试。',
  'workspace.files.watchLimit': '自动更新最多覆盖 {count} 个目录，其余目录请手动刷新。',
  'workspace.files.refreshFailed': '显示的是上次加载的内容，刷新失败：{reason}',
  'workspace.browser.address': '网址',
  'workspace.browser.addressPlaceholder': '搜索或输入网址',
  'workspace.browser.back': '后退',
  'workspace.browser.forward': '前进',
  'workspace.browser.reload': '刷新',
  'workspace.browser.stop': '停止加载',
  'workspace.browser.menu': '浏览器菜单',
  'workspace.browser.findInPage': '在页面中查找',
  'workspace.browser.findPlaceholder': '查找…',
  'workspace.browser.findMatches': '{index}/{total}',
  'workspace.browser.findClose': '关闭查找栏',
  'workspace.browser.print': '打印为 PDF',
  'workspace.browser.zoom': '缩放',
  'workspace.browser.zoomIn': '放大',
  'workspace.browser.zoomOut': '缩小',
  'workspace.browser.zoomReset': '重置缩放',
  'workspace.browser.capture': '截取屏幕截图',
  'workspace.browser.pickElement': '选取元素',
  'workspace.browser.annotationActive': '正在注释（Esc 退出）',
  'workspace.browser.downloads': '下载',
  'workspace.browser.downloadsEmpty': '暂无下载',
  'workspace.browser.revealDownload': '打开下载的文件',
  'workspace.browser.history': '历史记录',
  'workspace.browser.historyEmpty': '暂无访问记录',
  'workspace.browser.closeOverlay': '关闭',
  'workspace.browser.openExternal': '用系统浏览器打开',
  'workspace.browser.emptyTitle': '开始浏览',
  'workspace.browser.emptyBody': '输入 URL 以打开页面',
  'workspace.browser.loadFailed': '无法加载 {url}',
  'workspace.browser.pageCrashed': '页面无响应，已被重新加载。',
  'workspace.browser.pageClosed': '该页面已被浏览器关闭。',
  'workspace.browser.retry': '重试',
  'workspace.browser.unavailableTitle': '内置浏览器需要桌面版',
  'workspace.browser.unavailableBody': '当前环境没有原生浏览器视图，链接会改用系统浏览器打开。',
  'workspace.terminal.restart': '重新启动终端',
  'workspace.terminal.exited': '该终端已退出。',
  'workspace.review.sourceLabel': '比较范围',
  'workspace.review.sourceUnstaged': '未暂存',
  'workspace.review.sourceStaged': '已暂存',
  'workspace.review.sourceUncommitted': '全部未提交',
  'workspace.review.sourceBranch': '分支：{ref}',
  'workspace.review.unstageAll': '全部取消暂存',
  'workspace.review.stageHunk': '暂存此区块',
  'workspace.review.unstageHunk': '取消暂存此区块',
  'workspace.review.historyUnavailable': '此轮没有已记录的文件快照。',
  'workspace.review.unified': '统一 Diff',
  'workspace.review.split': '并排 Diff',
  'workspace.review.enableWrap': '开启自动换行',
  'workspace.review.disableWrap': '关闭自动换行',
  'workspace.review.collapseFile': '收起文件差异',
  'workspace.review.expandFile': '展开文件差异',
  'workspace.review.openFile': '在文件标签页中打开',
  'workspace.review.sourceTurn': '本轮改动',
  'workspace.review.sourceCommit': '提交 {sha}',
  'workspace.review.compareBranch': '比较分支…',
  'workspace.review.viewCommit': '查看提交…',
  'workspace.review.branchReference': '分支引用',
  'workspace.review.commitReference': '提交引用',
  'workspace.review.refRequired': '请输入引用。',
  'workspace.review.refUnavailable': '无法加载此比较。',
  'workspace.review.compare': '比较',
  'workspace.review.resolvedBase': '基准：{ref}',
  'workspace.review.filterFiles': '筛选文件…',
  'workspace.review.changeTree': '变更文件',
  'workspace.review.empty': '该范围没有变更',
  'workspace.review.stage': '暂存该文件',
  'workspace.review.unstage': '取消暂存',
  'workspace.review.revert': '还原改动',
  'workspace.review.stageAll': '暂存全部',
  'workspace.review.revertAll': '还原全部',
  'workspace.review.refresh': '刷新',
  'workspace.review.markViewed': '标记为已查看',
  'workspace.review.viewed': '已查看',
  'workspace.review.stale': '加载之后工作区已经发生变化，请刷新后重试。',
  'workspace.review.failed': 'Git 操作失败：{reason}',
  'workspace.review.revertTitle': '确认还原改动？',
  'workspace.review.revertBody': '将还原 {count} 个文件的工作区改动，执行前会保存可恢复副本。',
  'workspace.review.revertUntrackedWarning': '未跟踪文件单独列出，不会被批量还原删除。',
  'workspace.review.untracked': '未跟踪',
  'workspace.review.binary': '二进制文件',
  'workspace.review.conflicted': '存在冲突 —— 仅支持整文件操作',
  'workspace.review.notGitRepo': '当前目录不是 Git 仓库。',
  'workspace.review.noHead': '该仓库还没有任何提交。',
  'workspace.review.backupSaved': '可恢复副本已保存到 {path}',
  'workspace.review.sourceTurnHint': '所选轮次已记录的文件改动。只读，不包含之后的工作区编辑。',
  'workspace.review.readOnlySource': '该比较范围为只读。',
  'workspace.review.revertDeleteTitle': '还原改动并删除新文件？',
  'workspace.review.revertTrackedBody': '将还原 {count} 个已跟踪文件的工作区改动，执行前会保存可恢复副本。',
  'workspace.review.revertDeleteBody': '将从磁盘永久删除 {count} 个未跟踪文件。Git 从未保存过它们，只有执行前保存的副本能找回。',
  'workspace.review.revertDeleteList': '将被删除：{paths}',
  'workspace.review.revertDeleted': '已删除 {count} 个未跟踪文件，仅存的副本位于 {path}',
  'workspace.review.missingWorkdir': '会话的工作目录已不存在。',
  'workspace.review.refusedNoSnapshot': '请先加载该比较结果，再修改文件。',
  'workspace.review.diffTruncated': '文件过大，无法显示差异（{size}）',
  'workspace.review.statsTruncated': '过大，未统计',
...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  // Settings > Providers
  'settings.providers.title': '模型管理',
  'settings.providers.description': '配置模型、API 接口与访问凭证。',
  'settings.providers.addProvider': '添加模型',
  ...
  'settings.providers.fableModel': 'Fable 模型',
  ...
  'settings.providers.fableModelPlaceholder': '留空则由 Claude Code 决定',
  ...
  'settings.providers.toolSearchDesc': '默认关闭。仅当模型和最终上游都支持 tool_reference 时启用；不兼容的服务商可能返回 HTTP 400。',
  'settings.providers.toolSearchUnsupported': '当前仅 Anthropic Messages 格式支持 Tool Search；OpenAI 代理格式会保留完整工具 schema。',
  'settings.providers.toolSearchConfirmTitle': '确认启用 Tool Search？',
  'settings.providers.toolSearchConfirmBody': '仅当你使用 Anthropic 官方支持 Tool Search 的模型，并且最终 LLM 上游或网关明确支持 defer_loading 和 tool_reference 时才启用。',
  ...
  'settings.adapters.description': '配置即时通讯适配器，通过 Telegram、飞书、微信、钉钉、WhatsApp、企业微信、QQ 或 Slack 与 Claude Code 对话。首次配置请参考',
  ...
  'settings.adapters.pairingCodeHint': '在任意已接入平台的私聊里把这枚配对码发给 Bot。飞书、微信、钉钉、WhatsApp、企业微信和 QQ 需要先完成扫码绑定。',
  ...
  // Settings > IM 接入 —— 飞书扫码建机器人、企业微信、QQ、Slack
  ...
  'settings.adapters.feishuQrTitle': '扫码创建飞书机器人',
  'settings.adapters.feishuQrDesc': '用飞书手机 App 扫码，确认后自动创建机器人并写入 App ID / App Secret，无需去开放平台手动配置。',
  'settings.adapters.feishuStartAuth': '扫码创建',
  'settings.adapters.feishuRebind': '重新扫码',
  'settings.adapters.feishuUnbindApp': '解除机器人绑定',
  'settings.adapters.feishuUnbindAppConfirm': '确定解除这个飞书机器人绑定吗？解除后需要重新扫码或手动填写凭据，飞书才能继续收发消息。',
  'settings.adapters.feishuQrAlt': '飞书授权二维码',
  'settings.adapters.feishuWaiting': '等待飞书扫码确认...',
  'settings.adapters.feishuBindSuccess': '飞书机器人已创建并绑定。',
  'settings.adapters.feishuAuthFailed': '飞书扫码授权失败。',
  'settings.adapters.feishuUnbound': '飞书绑定已解除。',
  'settings.adapters.feishuUnbindFailed': '飞书解绑失败。',
  'settings.adapters.wecomQrTitle': '扫码创建企业微信机器人',
  'settings.adapters.wecomQrDesc': '用企业微信扫码创建智能机器人，成功后自动保存 Bot ID / Secret 并重启适配器。',
  'settings.adapters.wecomBind': '扫码绑定',
  'settings.adapters.wecomRebind': '重新扫码',
  'settings.adapters.wecomUnbindBot': '解除机器人绑定',
  'settings.adapters.wecomUnbindBotConfirm': '确定解除这个企业微信机器人绑定吗？解除后需要重新扫码，企业微信才能继续收发消息。',
  'settings.adapters.wecomQrAlt': '企业微信授权二维码',
  'settings.adapters.wecomWaiting': '等待企业微信扫码确认...',
  'settings.adapters.wecomBindSuccess': '企业微信机器人已绑定。',
  'settings.adapters.wecomBindFailed': '企业微信绑定失败。',
  'settings.adapters.wecomUnbound': '企业微信绑定已解除。',
  'settings.adapters.wecomUnbindFailed': '企业微信解绑失败。',
  'settings.adapters.wecomAllowedUsersPlaceholder': '如 zhangsan, lisi',
  'settings.adapters.wecomAllowedUsersHint': '填企业微信 userid，逗号分隔。留空则只允许已配对用户。',
  'settings.adapters.qqQrTitle': '扫码创建 QQ 机器人',
  'settings.adapters.qqQrDesc': '用手机 QQ 扫码授权，成功后自动保存 AppID / AppSecret 并重启适配器。',
  'settings.adapters.qqBind': '扫码绑定',
  'settings.adapters.qqRebind': '重新扫码',
  'settings.adapters.qqUnbindBot': '解除机器人绑定',
  'settings.adapters.qqUnbindBotConfirm': '确定解除这个 QQ 机器人绑定吗？解除后需要重新扫码，QQ 才能继续收发消息。',
  'settings.adapters.qqQrAlt': 'QQ 授权二维码',
  'settings.adapters.qqWaiting': '等待 QQ 扫码确认...',
  'settings.adapters.qqBindSuccess': 'QQ 机器人已绑定。',
  'settings.adapters.qqBindFailed': 'QQ 绑定失败。',
  'settings.adapters.qqUnbound': 'QQ 绑定已解除。',
  'settings.adapters.qqUnbindFailed': 'QQ 解绑失败。',
  'settings.adapters.qqAllowedUsersPlaceholder': '如 A1B2C3D4E5F6',
  'settings.adapters.qqAllowedUsersHint': '填 QQ 用户 openid，逗号分隔。留空则只允许已配对用户。',
  'settings.adapters.slackCreateAppTitle': '创建 Slack 应用',
  'settings.adapters.slackCreateAppDesc': 'Slack 没有扫码流程，改用应用清单：点下面的按钮会打开已预填权限和 Socket Mode 的创建页。',
  'settings.adapters.slackCreateAppAction': '用清单创建应用',
  'settings.adapters.slackStepCreate': '打开创建页，确认清单后创建应用。',
  'settings.adapters.slackStepInstall': '把应用安装到工作区，拿到 Bot Token（xoxb- 开头）。',
  'settings.adapters.slackStepTokens': '在 Basic Information 里生成 App-Level Token（xapp- 开头，勾选 connections:write），一起填到下方。',
  'settings.adapters.slackManifestToggle': '查看应用清单 JSON',
  'settings.adapters.slackManifestFailed': '无法获取 Slack 应用清单。',
  'settings.adapters.slackBotToken': 'Bot Token',
  'settings.adapters.slackBotTokenPlaceholder': 'xoxb- 开头',
  'settings.adapters.slackAppToken': 'App-Level Token',
  'settings.adapters.slackAppTokenPlaceholder': 'xapp- 开头，需要 connections:write',
  'settings.adapters.slackAllowedUsersPlaceholder': '如 U01ABCDEF, U02GHIJKL',
  'settings.adapters.slackUnbindApp': '解除 Slack 绑定',
  'settings.adapters.slackUnbound': 'Slack 绑定已解除。',
  'settings.adapters.slackUnbindFailed': 'Slack 解绑失败。',
  'settings.adapters.slackUnbindAppConfirm': '确定解除这个 Slack 应用绑定吗？解除后需要重新填写 Token，Slack 才能继续收发消息。',
  ...
  'settings.agents.form.modelDefaultDescription': '使用此 Claude Code 版本随附的默认模型。',
  'settings.agents.form.modelInheritDescription': '与主会话使用相同模型。',
  'settings.agents.form.modelAliasDescription': 'CLI 模型别名，会映射到当前 Provider 对应的模型。',
  'settings.agents.form.modelUnavailableDescription': '已保存的模型 ID；当前 Provider 未列出此模型。',
  'settings.agents.form.modelProviderHint': 'Agent 配置只保存模型 ID，不绑定 Provider；运行时使用会话当前的 Provider。',
  ...
  'settings.agents.rowEdit': '编辑 {name}',
  'settings.agents.rowDelete': '删除 {name}',
  'settings.agents.rowOverride': '调整 {name} 的模型和思考强度',
  'settings.agents.override': '调整模型',
  'settings.agents.overrideTitle': '调整内置 Agent',
  'settings.agents.overrideHint': '只能修改模型和思考强度。系统提示词、工具和颜色由 Claude Code 固定。',
  'settings.agents.overrideScopeHint': '保存到用户设置（~/.claude/settings.json），对所有项目生效。',
  'settings.agents.overrideDefault': '内置默认（{value}）',
  'settings.agents.overrideDefaultNone': '内置默认',
  'settings.agents.overrideReset': '恢复内置默认',
  'settings.agents.overrideBadge': '已覆盖',
  'settings.agents.overrideManaged': '由{source}设置指定，无法在此修改。',
  'settings.agents.overrideShadowed': '当前生效的是{source}的同名 Agent，此处的修改暂不会生效。',
  'settings.agents.overrideSaveError': '保存覆盖失败',
  'settings.agents.overrideResetError': '恢复默认失败',
  ...
  'settings.about.community': '加入 cc-haha 交流群',
  'settings.about.communityDesc': '企业微信群，扫码即可加入，群内交流以中文为主',
  'settings.about.communityHint': '使用微信或企业微信扫码加入',
  'settings.about.communityQrAlt': 'cc-haha 企业微信用户群二维码',
  ...
  'settings.general.proxyManagedSettingsWarning': '检测到用户配置仅剩 PROXY_MANAGED 代理占位信息，其他设置可能被代理工具覆盖。若这不是你的主动配置，请先关闭 CC Switch 路由接管并从备份恢复 settings.json；主动使用该配置可忽略。',
  ...
  'settings.general.effortDescription': '选择新会话默认使用的推理强度；可选档位跟随当前模型的能力定义。',
  'settings.general.effortDefaultLabel': '默认推理强度',
  'settings.general.effortSelectLabel': '默认推理强度：{level}',
  'settings.general.effortModelHint': '{model} 只显示其支持的档位；切换到其他模型时，会按该模型的能力自动回退。',
  'settings.general.effortNoModelHint': '连接或选择模型后，即可查看它支持的推理强度。',
  'settings.general.effortUnavailable': '不可调节',
  ...
  'settings.general.defaultEditorTitle': '默认编辑器',
  'settings.general.defaultEditorDescription': '文件的「打开方式」菜单里提供哪个编辑器。只列出本机已检测到的编辑器。',
  'settings.general.defaultEditorAuto': '自动选择',
  'settings.general.agentTeamsTitle': 'Agent Teams 智能体团队',
  'settings.general.agentTeamsDescription': '让多个 Agent 分工协作，共同完成任务。',
  'settings.general.agentTeamsEnabled': '启用 Agent Teams',
  'settings.general.agentTeamsHint': '对新建会话生效，已有会话重启应用后生效。',
  'settings.general.agentTeamsSaveFailed': 'Agent Teams 设置保存失败，请重试。',
  'settings.general.workflowKeywordTitle': 'Ultracode',
  'settings.general.workflowKeywordDescription': '控制独立出现的 Ultracode 关键词是否让当前提示词进入动态 Workflow 编排。',
  'settings.general.workflowKeywordEnabled': '启用 Ultracode 关键词触发',
  'settings.general.workflowKeywordHint': '可触发的关键词会在发送前高亮；代码块、引号、路径、flag 和连字符字面量保持原义。',
  ...
  'settings.general.networkTimeoutHint': '用于服务商请求、流式首个响应，以及服务商连接测试。至少 30 秒；本地模型长时间思考时，可设为 14400 秒（4 小时）或更长。调大后，单次流式回复的总时长上限同步放宽（不低于 600 秒）。',
  ...
  'slash.saveWorkflow.title': '保存工作流',
  'slash.saveWorkflow.subtitle': '将已完成的工作流保存为可复用的斜杠命令。',
  'slash.saveWorkflow.noCompletedRun': '请先在此会话中完成一个工作流，再使用 /save-workflow 保存。',
  'slash.saveWorkflow.runLabel': '已完成的运行',
  'slash.saveWorkflow.nameLabel': '命令名称',
  'slash.saveWorkflow.namePlaceholder': '例如 release-audit',
  'slash.saveWorkflow.scopeLabel': '保存范围',
  'slash.saveWorkflow.scopeProject': '项目',
  'slash.saveWorkflow.scopeUser': '用户',
  'slash.saveWorkflow.save': '保存工作流',
  'slash.saveWorkflow.loading': '正在加载工作流…',
  'slash.saveWorkflow.retry': '重试',
  'slash.saveWorkflow.success': '已保存为 /{name}。请新建会话并运行 /{name}。',
  'slash.saveWorkflow.error': '无法保存工作流：{detail}',
  'slash.saveWorkflow.invalidName': '名称只能包含字母、数字、连字符或下划线，且必须以字母或数字开头。',
  'slash.saveWorkflow.reservedName': '/{name} 是桌面端保留命令，请使用其他名称。',
  'slash.saveWorkflow.existingName': '/{name} 已是可用命令，请使用其他名称。',
  ...
  'contextIndicator.breakdown': '构成明细',
  'contextIndicator.sessionCacheHit': '缓存命中',
  'contextIndicator.sessionSpeed': '生成速度',
  'contextIndicator.sessionCost': '会话费用',
  ...
  'chat.turnChangesConversationOnlySubtitle': '文件检查点不完整，撤销只能回滚对话，不还原文件',
  'chat.turnChangesUndoConversationOnly': '只回滚对话',
  'chat.turnChangesConversationOnlyConfirmBody': '这一轮的文件检查点不完整，无法安全还原文件。只回滚对话会把会话退回这一轮之前，磁盘上的文件保持现状。',
  'chat.turnChangesPartialCoverageSubtitle': '撤销可还原上面这些文件；{sources} 的改动未被检查点记录，不会被撤销',
  'chat.turnChangesPartialCoverageConfirmBody': '注意：{sources} 造成的文件改动没有被检查点记录，撤销不会还原它们。',
  ...
  'agentActivity.loading': '正在加载工具活动…',
  'agentActivity.failed': '无法加载该子代理的工具活动。',
  'agentActivity.retry': '重试',
  'agentActivity.truncated': '仅显示该运行的开始与结尾，打开运行可查看完整轨迹。',
  ...
  'teams.archivedMemberSessionHint': '这里保留了该成员当时的完整对话与工具调用。',
  'teams.archivedMemberReadOnly': '这是只读的历史执行记录；如需继续工作，请返回主控会话。',
  'agentTeams.title': 'Agent Teams 协作工作台',
  'agentTeams.sharedTaskList': '共享任务列表',
  'agentTeams.experimental': '实验特性',
  'agentTeams.stats.phase': '阶段',
  'agentTeams.stats.completed': '完成',
  'agentTeams.stats.running': '进行中',
  'agentTeams.stats.available': '待领',
  'agentTeams.stats.blocked': '阻塞',
  'agentTeams.live.following': '实时 · 跟随团队',
  'agentTeams.live.runningHint': '正在跟随 {count} 个成员的实时进度，回放控制在团队结束后开放',
  'agentTeams.live.formingHint': '队长正在召唤成员，回放控制在团队结束后开放',
  'agentTeams.live.waitingHint': '等待成员认领下一批任务，回放控制在团队结束后开放',
  'agentTeams.live.elapsed': '已运行',
  'agentTeams.live.sessionClock': '会话时钟',
  'agentTeams.replay.play': '播放',
  'agentTeams.replay.pause': '暂停',
  'agentTeams.replay.replay': '重播',
  'agentTeams.replay.speed': '回放速度',
  'agentTeams.replay.timeline': '回放时间轴 · 点击跳转',
  'agentTeams.canvas.formation': '1 · 编队 — 队长居中，成员在下',
  'agentTeams.canvas.tasks': '2 · 共享任务列表 — 按依赖分层，左 → 右',
  'agentTeams.canvas.laneRoot': '无依赖 · 可立即领',
  'agentTeams.canvas.laneDepth': '第 {layer} 层',
  'agentTeams.canvas.laneWrapUp': '收尾',
  'agentTeams.legend.unmet': '依赖未满足',
  'agentTeams.legend.satisfied': '依赖已满足（流向下游）',
  'agentTeams.legend.tether': '成员正在执行该任务',
  'agentTeams.legend.unlocked': '刚解锁',
  'agentTeams.legend.flight': '飞行中的消息 / 认领',
  'agentTeams.member.inbox': '收件箱 {count}',
  'agentTeams.member.executingTask': '执行 #{task}',
  'agentTeams.member.waitingForTask': '空闲 · 等待任务',
  'agentTeams.member.waitingForDependency': '空闲 · 等 #{task} 解锁',
  'agentTeams.member.waitingForClose': '空闲 · 等待关闭',
  'agentTeams.lead.forming': '组建团队',
  'agentTeams.lead.coordinating': '协调 · 等待汇报',
  'agentTeams.lead.finishing': '收尾归并',
  'agentTeams.lead.archived': '运行已归档',
  'agentTeams.task.start': '起点',
  'agentTeams.task.unlocked': '刚解锁',
  'agentTeams.task.reconstructedOwner': '推断负责人',
  'agentTeams.communication.open': '展开通讯面板',
  'agentTeams.communication.close': '收起通讯面板',
  'agentTeams.communication.backToFeed': '返回通讯流',
  'agentTeams.inspector.independentContext': '{role} · 独立上下文',
  'agentTeams.inspector.current': '当前',
  'agentTeams.inspector.completedTasks': '已完成',
  'agentTeams.inspector.messages': '收发',
  'agentTeams.inspector.taskHistory': '任务履历',
  ...
  'agentTeams.hideReport': '隐藏 Agent Teams 运行报告',
  'agentTeams.closeReport': '关闭 Agent Teams 运行报告',
  'agentTeams.loading': '正在等待 Agent Teams 活动…',
  'agentTeams.phase.forming': '组建团队',
  'agentTeams.phase.running': '并行执行',
  'agentTeams.phase.finishing': '收尾中',
  'agentTeams.phase.completed': '已完成',
  'agentTeams.progressLabel': '团队任务进度',
  'agentTeams.followingLive': '跟随实时',
  'agentTeams.reviewHistory': '回看历史',
  'agentTeams.older': '更早的工作台状态',
  'agentTeams.newer': '更新的工作台状态',
  'agentTeams.backToLive': '回到实时',
  'agentTeams.live': '实时',
  'agentTeams.leader': '长',
  'agentTeams.restArea': '休息区',
  'agentTeams.emptyTasks': '正在组建团队；任务创建后，依赖图将出现在这里。',
  'agentTeams.resizePanel': '调整 Agent Teams 工作台宽度',
  'agentTeams.task.blocked': '阻塞',
  'agentTeams.task.open': '待领',
  'agentTeams.task.running': '执行中',
  'agentTeams.task.completed': '完成',
  'agentTeams.task.closeDetail': '关闭任务详情',
  'agentTeams.task.ownerLabel': '负责人',
  'agentTeams.task.dependsOn': '依赖',
  'agentTeams.task.unblocks': '解锁',
  'agentTeams.openTask': '查看任务：{subject}',
  'agentTeams.task.inferredOwner': '{name}（推断）',
  'agentTeams.task.layer': '第 {layer} 层',
  'agentTeams.task.dependencies': '依赖 {dependencies}',
  'agentTeams.task.unclaimed': '等待成员领取',
  'agentTeams.task.completedNoOwner': '已完成 · 未记录负责人',
  ...
  'agentTeams.communication.title': '通讯',
  'agentTeams.communication.count': '{count} 条',
  'agentTeams.communication.all': '全部',
  'agentTeams.communication.timeline': '任务时间轴',
  'agentTeams.communication.timeAll': '全程',
  'agentTeams.communication.timeEarly': '开始',
  'agentTeams.communication.timeMiddle': '推进',
  'agentTeams.communication.timeLate': '收尾',
  'agentTeams.communication.empty': '团队消息会出现在这里。',
  'agentTeams.communication.direct': '私信',
  'agentTeams.communication.broadcast': '广播',
  'agentTeams.communication.system': '系统',
  'agentTeams.communication.everyone': '全体',
  'agentTeams.communication.taskAssignment': '指派 {name}：{task} {subject}',
  'agentTeams.communication.taskClaimed': '{name} 领取了 {task} {subject}',
  'agentTeams.communication.assignment': '指派',
  'agentTeams.communication.peer': '私信',
  'agentTeams.communication.report': '汇报',
  'agentTeams.communication.shutdownRequest': '请求结束：{reason}',
  'agentTeams.communication.shutdownResponse': '已收到退出确认',
  'agentTeams.communication.idle': '成员已进入待命状态',
  'agentTeams.disbanded': '团队已解散，成果并入主会话',
  'agentTeams.memberDetails': '{name} 的详情',
  'agentTeams.memberTasks': '负责任务',
  'agentTeams.noMemberTasks': '暂未分配任务。',
  'agentTeams.memberMessages': '相关消息',
  'agentTeams.noMemberMessages': '暂无相关消息。',
  'agentTeams.fullConversationHint': '完整会话、工具调用与流式输出复用既有会话视图。',
  'agentTeams.archivedConversationHint': '打开保留的执行会话，可回看完整对话与工具调用。',
  ...
  'agentTeams.inline.coordination': '团队编排记录 · {count} 步',
  'agentTeams.inline.open': '打开运行报告',
  'agentTeams.report.title': 'Agent Teams 运行报告',
  'agentTeams.report.openWorkbench': '工作台',
  'agentTeams.report.tasksDone': '任务完成',
  'agentTeams.report.members': '成员 {count}',
  'agentTeams.report.tasks': '任务 {count}',
  'agentTeams.report.ownedTasks': '{count} 项',
  'agentTeams.report.messages': '{count} 条通讯记录',
  'agentTeams.report.disbanded': '团队已解散，成果并入主会话',
  ...
  'agentTeams.report.memberStatus.error': '出错',
  ...
  // ─── SubAgent Run ──────────────────────────────────────
  'subagentRun.incompleteHistory': '部分历史记录无法读取，已显示可用内容；可刷新重试。',
  ...
  'subagentRun.readOnly': '这是一次性子代理的运行记录，不支持继续对话。',
  ...
  'session.apiTokensWithCache': '{count} tokens（含缓存）',
  'session.apiTokenBreakdown': 'API 用量：{total} tokens · 输入 {input} · 输出 {output} · 缓存读取 {cacheRead} · 缓存写入 {cacheWrite}',
  'session.historyLoadFailed': '历史会话加载失败。',
  'session.historyTooLarge': '该会话历史过大，无法在此加载。',
  ...
  'chat.retry.rateLimit': '已达到用量或速率限制',
  'chat.retry.networkError': '网络错误',
  'chat.retry.waiting': '等待 {seconds}s',
  'chat.retry.waitingLong': '约 {duration} 后重试',
  ...
  'slashCmd.saveWorkflow.description': '保存已完成的 Workflow 以便复用',
  ...
  'browser.selection.cleanupFailed': '无法停止选择或撤回超额项：{reason}',
